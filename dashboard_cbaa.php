...
$courses_result = $conn->query("SELECT course_name FROM courses WHERE department='Business Administration and Accountancy' AND (is_deleted = 0 OR is_deleted IS NULL) ORDER BY course_name ASC");
$courses = [];
...
// Add default CBAA courses if none exist in database
if (empty($courses)) {
    $courses = [
...
$board_exam_types_result = $conn->query("SELECT id, exam_type_name FROM board_exam_types WHERE department='Business Administration and Accountancy' AND (is_deleted = 0 OR is_deleted IS NULL) ORDER BY exam_type_name ASC");
$board_exam_types = [];
...
if (empty($board_exam_types)) {
    $board_exam_types = [
        ['id' => 1, 'name' => 'Certified Public Accountant Licensure Exam (CPALE)'],
        ['id' => 2, 'name' => 'Real Estate Broker Licensure Exam (REBLE)'],
        ['id' => 3, 'name' => 'Certified Management Accountant (CMA)'],
        ['id' => 4, 'name' => 'Customs Broker Licensure Exam (CBLE)']
    ];
}
...
$board_exam_dates_result = $conn->query(
  ...
  . "WHERE bed.department='Business Administration and Accountancy' AND (bed.is_deleted = 0 OR bed.is_deleted IS NULL) ORDER BY bed.exam_date DESC"
);
$board_exam_dates = [];
...
<head>
    ...
    <title>CBAA - BOARD PASSING RATE SYSTEM</title>
    ...
    * {
    ...
    .filter-section {
        ...
        margin-bottom: 24px;
        overflow: hidden;
        box-shadow: 0 8px 32px rgba(135, 121, 40, 0.12), 0 2px 8px rgba(0, 0, 0, 0.04);
        position: relative;
        z-index: 10;
    }
    ...
    .export-main-btn:active {
        ...
        box-shadow: 0 6px 20px rgba(135, 121, 40, 0.4);
        transition: all 0.1s ease;
    }
    ...
    @keyframes corner-lightning-tr {
        ...
        0%,
        100% {
            background: linear-gradient(45deg, #C9A84F, #D4AF37, #E8C468);
            transform: scale(1);
            opacity: 0.8;
        }

        50% {
            background: linear-gradient(45deg, #B8941F, #E8C468, #D4AF37);
            transform: scale(1.1);
            opacity: 1;
        }
    }
    ...
    #logoutModal::before {
        ...
        background: linear-gradient(225deg, #D4AF37, #E8C468, #C9A84F) !important;
    ...
    #logoutModal::after {
        ...
        width: 40px !important;
        height: 40px !important;
        background: linear-gradient(315deg, #C9A84F, #D4AF37, #E8C468) !important;
    ...
    @keyframes corner-lightning-bl {
        ...
        0%,
        100% {
            background: linear-gradient(225deg, #D4AF37, #E8C468, #C9A84F);
            transform: scale(1);
            opacity: 0.8;
        }

        50% {
            background: linear-gradient(225deg, #E8C468, #C9A84F, #B8941F);
            transform: scale(1.1);
            opacity: 1;
        }
    }
    ...
    @keyframes corner-lightning-br {
        ...
        0%,
        100% {
            background: linear-gradient(315deg, #C9A84F, #D4AF37, #E8C468);
            transform: scale(1);
            opacity: 0.8;
        }

        50% {
            background: linear-gradient(315deg, #B8941F, #E8C468, #D4AF37);
            transform: scale(1.1);
            opacity: 1;
        }
    }
    ...
    .export-modal-content::before {
        ...
        right: 0;
        bottom: 0;
        background: linear-gradient(135deg, rgba(212, 175, 55, 0.02) 0%, rgba(201, 168, 79, 0.02) 100%);
        border-radius: 24px;
        pointer-events: none;
    }
...
<body>
        ...
        <div class="modal-content export-confirm-content">
            ...
            <div class="export-confirm-details">
                ...
                <div class="export-detail-item">
                    ...
                    <span id="exportFileName" class="export-detail-value">Ccba_Board_Passers.csv</span>
                </div>
            </div>
    ...
    */
    ...
    function handleAddFormSubmission() {
        ...
        fetch('add_board_passer_cbaa.php', {
                method: 'POST',
                body: formData,
                headers: {
                    'X-Requested-With': 'XMLHttpRequest'
    ...
    function performCSVExport(headers, data) {
        try {
            ...
            link.setAttribute('download', `board_passers_ccba_${new Date().toISOString().slice(0,10)}.csv`);
    ...
    function initializeKeyboardShortcuts() {
        ...
        const filename = `Ccba_Board_Passers_${timestamp}.${selectedFormat.extension}`;
    ...
    function performCSVExport() {
        ...
        const filename = `Ccba_Board_Passers_${getCurrentDateString()}.csv`;
    ...
    function performExcelExport() {
        ...
        const filename = `Ccba_Board_Passers_${getCurrentDateString()}.xls`;
    ...
    function exportToCSV(data) {
        ...
        downloadFile(csvContent, 'board_passers_cbaa.csv', 'text/csv');
    ...
    function exportToExcel(data) {
        ...
        downloadFile(csvContent, 'board_passers_cbaa.xls', 'application/vnd.ms-excel');
    ...
    function exportToJSON(data) {
        ...
        downloadFile(jsonContent, 'board_passers_cbaa.json', 'application/json');
    ...
    function exportAsCSV() {
        ...
        downloadFile(csvData, `Ccba_Board_Passers_${getCurrentDateString()}.csv`, 'text/csv');
    ...
    function exportAsExcel() {
        ...
        downloadFile(excelData, `Ccba_Board_Passers_${getCurrentDateString()}.xls`, 'application/vnd.ms-excel');
...
<body>
  ...
  <div class="footer">
    ...
    Address: Sta. Cruz, Laguna, Philippines
        ...
        const filename = `LSPU_Ccba_Board_Passers_${getCurrentDateString()}.html`;
