...
$courses_result = $conn->query("SELECT course_name FROM courses WHERE department='Teacher Education' ORDER BY course_name ASC");
$courses = [];
...
$board_exam_types_result = $conn->query("SELECT id, exam_type_name FROM board_exam_types WHERE department='Teacher Education' ORDER BY exam_type_name ASC");
$board_exam_types = [];
...
if (empty($board_exam_types)) {
    $board_exam_types = [
        ['id' => 1, 'name' => 'Licensure Examination for Teachers (LET) - Elementary'],
        ['id' => 2, 'name' => 'Licensure Examination for Teachers (LET) - Secondary']
    ];
}
...
$board_exam_dates_result = $conn->query(
  ...
  . "WHERE bed.department='Teacher Education' ORDER BY bed.exam_date DESC"
);
$board_exam_dates = [];
...
<head>
    ...
    <title>CTE Dashboard - BOARD PASSING RATE SYSTEM</title>
    ...
    * {
    ...
    .shortcuts-btn {
        ...
        color: #066;
        /* deep teal text */
        border: 2px solid rgba(70, 99, 172, 0.35);
        border-radius: 12px;
        padding: 10px 16px;
        font-size: 0.9rem;
        font-weight: 600;
    ...
    .shortcuts-btn:hover {
        background: rgba(70, 99, 172, 0.15);
        border-color: rgba(70, 99, 172, 0.55);
    ...
    .board-table th {
        ...
        top: 0;
        z-index: 10;
        box-shadow: 0 2px 8px rgba(70, 99, 172, 0.18);
    ...
    textarea:focus {
        outline: none;
        border-color: #4663ac;
        box-shadow: 0 0 0 3px rgba(70, 99, 172, 0.2);
    }
    ...
    .add-first-btn:hover {
        ...
        background: linear-gradient(135deg, #2563eb, #4663ac);
    }
    ...
    .filter-section {
        ...
        margin-bottom: 24px;
        overflow: visible;
        box-shadow: 0 4px 16px rgba(70, 99, 172, 0.15);
        position: relative;
        z-index: 10;
    }
    ...
    .filter-header {
        ...
        background: linear-gradient(135deg, #4663ac 0%, #0891a8 100%);
    ...
    .toggle-btn {
        ...
        gap: 8px;
        transition: all 0.3s ease;
        box-shadow: 0 2px 8px rgba(70, 99, 172, 0.2);
    }
    ...
    .filter-input:focus {
        border-color: #4663ac;
        box-shadow: 0 0 0 3px rgba(70, 99, 172, 0.25);
    }
    ...
    .search-input:focus {
        border-color: #4663ac;
        box-shadow: 0 0 0 4px rgba(70, 99, 172, 0.18);
        transform: translateY(-1px);
    }
    ...
    .search-clear:hover {
        background: linear-gradient(135deg, #c1d8f0 0%, #047a89 100%);
    ...
    .export-main-btn:hover {
        ...
        background: linear-gradient(135deg, #4663ac 0%, #2563eb 100%);
    }
    ...
    .modal-header {
        ...
        text-align: center;
        position: relative;
        background: linear-gradient(135deg, #4663ac 0%, #3b82f6 50%, #60a5fa 100%);
        color: white;
    }
    ...
    #editStudentModal .modal-header {
        background: linear-gradient(135deg, #0ea5b1 0%, #4663ac 45%, #60a5fa 100%);
        color: #fff;
    }
    ...
    #editStudentModal .tab-header .tab-icon {
        background: linear-gradient(135deg, #4663ac 0%, #3b82f6 100%);
        box-shadow: 0 8px 20px rgba(70, 99, 172, 0.25);
    }
    ...
    #editStudentModal .form-group select:focus {
        border-color: #4663ac;
        box-shadow: 0 0 0 4px rgba(70, 99, 172, 0.15);
        transform: translateY(-1px);
    }
    ...
    #editStudentModal .btn-primary {
        background: linear-gradient(135deg, #4663ac 0%, #0ea5b1 100%);
        color: #fff;
        box-shadow: 0 10px 24px rgba(70, 99, 172, 0.35);
    }

    #editStudentModal .btn-primary:hover {
        background: linear-gradient(135deg, #0d95a5 0%, #0a8e9a 100%);
        box-shadow: 0 14px 30px rgba(70, 99, 172, 0.45);
        transform: translateY(-2px);
    }
    ...
    #logoutModal .modal-content::before {
        ...
        background: linear-gradient(135deg, #4663ac 0%, #3182ce 25%, #60a5fa 50%, #3182ce 75%, #4663ac 100%) !important;
    ...
    #logoutModal .modal-header::before {
        ...
        background: linear-gradient(90deg, #4663ac 0%, #3182ce 50%, #60a5fa 100%) !important;
    ...
    #logoutModal .modal-icon {
        ...
        background: linear-gradient(135deg, #4663ac 0%, #3182ce 50%, #2563eb 100%) !important;
        border-radius: 50% !important;
        display: flex !important;
        align-items: center !important;
        justify-content: center !important;
    ...
    #logoutModal .modal-icon::before {
        ...
        background: linear-gradient(135deg, #60a5fa, #3182ce, #4663ac, #2563eb) !important;
        border-radius: 50% !important;
        z-index: -1 !important;
    ...
    #logoutModal .modal-title {
        ...
        background: linear-gradient(135deg, #4663ac 0%, #2563eb 100%) !important;
    ...
    #logoutModal .modal-btn.logout-confirm:hover {
        background: linear-gradient(135deg, #1e3a8a 0%, #4663ac 50%, #1d4ed8 100%) !important;
    ...
    #logoutModal .modal-btn.logout-confirm:active {
        ...
        background: linear-gradient(135deg, #1e3a8a 0%, #1d4ed8 50%, #4663ac 100%) !important;
    }
    ...
    @keyframes corner-lightning-tr {
        ...
        50% {
            background: linear-gradient(45deg, #4663ac, #60a5fa, #3182ce);
            transform: scale(1.1);
            opacity: 1;
        }
    }
    ...
    @keyframes corner-lightning-bl {
        ...
        50% {
            background: linear-gradient(225deg, #60a5fa, #2c5aa0, #4663ac);
            transform: scale(1.1);
            opacity: 1;
        }
    }
    ...
    @keyframes corner-lightning-br {
        ...
        50% {
            background: linear-gradient(315deg, #4663ac, #60a5fa, #3182ce);
            transform: scale(1.1);
            opacity: 1;
        }
    }
    ...
    .json-icon {
        background: linear-gradient(135deg, #c8d9ed 0%, #4663ac 100%);
    }
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="stats-grid">
            <div class="stat-card">
                <div class="stat-icon" style="background: linear-gradient(135deg, #4663ac 0%, #c1d8f0 100%);">
          ...
          ?>
            ...
            <div class="stat-card">
                <div class="stat-icon" style="background: linear-gradient(135deg, #c1d8f0 0%, #e1f1fd 100%);">
          ...
          ?>
            ...
            <div class="stat-card">
                <div class="stat-icon" style="background: linear-gradient(135deg, #c8d9ed 0%, #4663ac 100%);">
    ...
    <div id="editStudentModal" class="custom-modal" style="display: none;">
        <div class="modal-content add-modal-content">
            <div class="modal-header add-modal-header">
                ...
                <h3>Edit LET Passer</h3>
                <p>Update teacher education student information</p>
            ...
            <form id="editStudentForm">
                ...
                <!-- LET Exam Details section header -->
                <div class="tab-header" style="padding: 16px 24px 0;">
                    <div class="tab-icon"><i class="fas fa-certificate"></i></div>
                    <h4>LET Exam Details</h4>
                    <p>Provide LET type, date, and rating</p>
                </div>
                ...
                <div class="form-grid" style="padding: 0 24px;">
                    ...
                    <div class="form-group" style="grid-column: 1 / -1;">
                        <label for="editBoardExamType"><i class="fas fa-certificate"></i>LET Level *</label>
                        <select id="editBoardExamType" name="board_exam_type" required>
                            <option value="">Select LET Level</option>
                    ...
                    <div class="form-group">
                        <label for="editExamDate"><i class="fas fa-calendar-check"></i>LET Exam Date</label>
                        ...
                        <div id="editExamDateHint" class="small-hint"
                            style="display:none;color:#6b7280;font-size:12px;margin-top:6px;">Select LET Level first
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="editRating"><i class="fas fa-percentage"></i>General Average</label>
                ...
                <div style="padding: 0 24px 16px; margin-top: 8px;">
                    <div id="editSubjectsContainer"
                        ...
                        <div
                            ...
                            <i class="fas fa-book"></i>Per-subject Ratings (LET)
                        </div>
    ...
    <div id="addStudentModal" class="custom-modal">
        <div class="modal-content add-modal-content">
            <div class="modal-header add-modal-header">
                ...
                <h3>Add New LET Passer</h3>
                <p>Enter teacher education student information</p>
            ...
            <form id="addStudentForm">
                ...
                <div id="personalTab" class="tab-content active">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="addFirstName" name="first_name" required placeholder="Maria Clara"
                                title="Only letters, spaces, commas, periods, apostrophes, and hyphens allowed">
                            <div class="input-feedback"></div>
                        </div>
                ...
                <!-- LET Exam Information Tab -->
                <div id="examTab" class="tab-content">
                    <div class="tab-header">
                        <div class="tab-icon">
                            <i class="fas fa-graduation-cap"></i>
                        </div>
                        <h4>LET Exam Information</h4>
                        <p>Enter Licensure Examination for Teachers details</p>
                    </div>
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            <label for="addExamDate">
                                <i class="fas fa-calendar-check"></i>LET Exam Date *
                            </label>
                        ...
                        <div class="form-group" style="grid-column: 1 / -1;">
                            <label for="addBoardExamType">
                                <i class="fas fa-certificate"></i>LET Level *
                            </label>
    ...
    <div id="exportConfirmModal" class="modal" style="display: none;">
        <div class="modal-content export-confirm-content">
            <div class="modal-header export-confirm-header">
                ...
                <h3 id="exportConfirmTitle">Confirm LET Export</h3>
                <p id="exportConfirmMessage">Are you sure you want to export the LET data?</p>
            </div>
            ...
            <div class="export-confirm-details">
                ...
                <div class="export-detail-item">
                    ...
                    <span id="exportFileName" class="export-detail-value">CTE_LET_Passers.csv</span>
                </div>
            </div>
    ...
    <!-- Update Confirmation Modal (CTE) -->
    <div id="updateModal" class="modal">
        <div class="modal-content">
            <div class="modal-header"
                style="background: linear-gradient(135deg, #c8d9ed 0%, #4663ac 100%); color: white;">
                <div class="modal-icon">
                    <i class="fas fa-exclamation-triangle"></i>
                </div>
                <h3>Review and Confirm LET Updates</h3>
            </div>
            ...
            <div class="modal-body"
                ...
                <div
                    ...
                    <i class="fas fa-chalkboard-teacher"
                        style="font-size: 2rem; color: #ef4444; margin-bottom: 12px;"></i>
                    <p style="color: #374151; font-size: 1.1rem; line-height: 1.6; margin: 0;">
                        Are you sure you want to delete this LET passer's record?<br>
                        <small style="color: #6b7280; font-size: 0.9rem;">This action will permanently remove all LET
                            data
    ...
    */
    ...
    function showEditConfirmationModal(originalData, newData, formData) {
      ...
      `;
        ...
        <div class="confirm-modal-content" style="
          ...
          border-radius: 24px;
          box-shadow: 0 25px 50px -12px rgba(0, 0, 0, 0.25);
          border: 2px solid rgba(70, 99, 172, 0.12);
          overflow: hidden;
          position: relative;
          max-width: 650px;
          width: 100%;
        ...
        ">
          ...
          <div class="confirm-modal-dark-bg" style="
            background: linear-gradient(135deg, #0ea5b1 0%, #4663ac 100%);
          ...
          ">
            <div style="background: #f7fafc; padding: 24px; border-radius: 16px; border: 1px solid #e2e8f0; margin-bottom: 24px;">
              <h4 style="color: #2d3748; margin: 0 0 16px 0; font-weight: 700; font-size: 1.1rem;">
                <i class="fas fa-user-graduate" style="margin-right: 8px; color: #4663ac;"></i>
              ...
              <div style="color: #0ea5b1; margin-bottom: 16px; font-weight: 800; border-top: 1px solid #e2e8f0; padding-top: 16px; letter-spacing: .2px;">
                <i class="fas fa-clipboard-list" style="margin-right: 8px; color: #4663ac;"></i>
                Summary of Changes:
              </div>
        ...
        Object.keys(originalData).forEach(key => {
            ...
            ">
              ...
              <div style="display: flex; align-items: center; gap: 10px; font-size: 0.92rem;">
                ...
                <i class="fas fa-arrow-right" style="color: #4663ac; font-size: 0.75rem;"></i>
    ...
    function handleAddFormSubmission() {
        ...
        fetch('add_board_passer_cte.php', {
                method: 'POST',
                body: formData,
                headers: {
                    'X-Requested-With': 'XMLHttpRequest'
    ...
    function performCSVExport(headers, data) {
        try {
            ...
            link.setAttribute('download', `board_passers_ccte_${new Date().toISOString().slice(0,10)}.csv`);
    ...
    function performPDFExport(headers, data) {
        try {
          ...
          <html>
          <head>
            <title>Board Passers Report - CTE</title>
            <style>
          ...
          <body>
            ...
            <div class="header-info">
              <p><strong>Department:</strong> College of CTE</p>
            ...
            <div class="footer">
              <p>Board Passing Rate System - CTE Department</p>
            </div>
          </body>
          </html>
        `);
    ...
    function initializeKeyboardShortcuts() {
        ...
        const filename = `Cte_Board_Passers_${timestamp}.${selectedFormat.extension}`;
    ...
    function performCSVExport() {
        ...
        const filename = `Cte_Board_Passers_${getCurrentDateString()}.csv`;
    ...
    function performExcelExport() {
        ...
        const filename = `Cte_Board_Passers_${getCurrentDateString()}.xls`;
    ...
    function exportToCSV(data) {
        ...
        downloadFile(csvContent, 'board_passers_ccte.csv', 'text/csv');
    ...
    function exportToExcel(data) {
        ...
        downloadFile(csvContent, 'board_passers_ccte.xls', 'application/vnd.ms-excel');
    ...
    function exportToJSON(data) {
        ...
        downloadFile(jsonContent, 'board_passers_ccte.json', 'application/json');
    ...
    function exportToPDF(data) {
        ...
        <head>
          <meta charset="UTF-8">
          <title>LSPU CTE Board Passers Report</title>
          <style>
            @page {
              size: A4 landscape;
              margin: 15mm 20mm;
        ...
        <body>
          ...
          <div class="header">
            ...
            <div class="department">College of CTE</div>
          ...
          <!-- Footer -->
          <div class="footer">
            <p><strong>Laguna State Polytechnic University - College of CTE</strong></p>
    ...
    function exportAsCSV() {
        ...
        downloadFile(csvData, `Cte_Board_Passers_${getCurrentDateString()}.csv`, 'text/csv');
    ...
    function exportAsExcel() {
        ...
        downloadFile(excelData, `Cte_Board_Passers_${getCurrentDateString()}.xls`, 'application/vnd.ms-excel');
    ...
    function generateExcelData(rows) {
        ...
        <html>
          ...
          <body>
            <h2>CTE Board Passers - ${getCurrentDateString()}</h2>
            <table>
              <thead>
                <tr>
                  <th>Name</th>
...
<html>
<head>
  <title>CTE Board Passers Report</title>
  <meta charset="UTF-8">
  <style>
...
<body>
  ...
  <div class="footer">
    <strong>Laguna State Polytechnic University - College of CTE</strong><br>
    ...
    Address: Sta. Cruz, Laguna, Philippines
        ...
        const filename = `LSPU_Cte_Board_Passers_${getCurrentDateString()}.html`;
    ...
    ">
        ...
        background: linear-gradient(135deg, #4663ac 0%, #3182ce 50%, #60a5fa 100%);
        border-bottom: none;
        position: relative;
        color: white;
        padding: 32px 40px 28px;
