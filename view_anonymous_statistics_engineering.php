...
<head>
    ...
    <title>Engineering Admin Dashboard</title>
    ...
    <style>
        ...
        * {
        ...
        body::before {
            ...
            bottom: 0;
            background: 
                radial-gradient(circle at 20% 50%, rgba(145, 179, 142, 0.1) 0%, transparent 50%),
        ...
        .page-header {
            ...
            border-radius: 20px;
            box-shadow: 0 8px 32px rgba(145, 179, 142, 0.15);
        ...
        .chart-card {
            ...
            padding: 32px;
            box-shadow: 
                0 10px 40px rgba(145, 179, 142, 0.12),
        ...
        .chart-card::before {
            ...
            right: 0;
            height: 4px;
            background: linear-gradient(90deg, #8BA49A, #3B6255, #8BA49A);
        ...
        .chart-card:hover {
            ...
            box-shadow: 
                0 15px 50px rgba(145, 179, 142, 0.2),
        ...
        .info-btn:hover {
            transform: scale(1.1);
            box-shadow: 0 4px 12px rgba(145, 179, 142, 0.5);
        }
        ...
        .filter-select select:focus {
            outline: none;
            border-color: #8BA49A;
            box-shadow: 0 0 0 3px rgba(145, 179, 142, 0.1);
        }
    ...
    #logoutModal .modal-content {
        background: linear-gradient(135deg, #8BA49A 0%, #CBDED3 100%) !important;
        ...
        animation: slideInLogout 0.3s ease-out !important;
    ...
    #logoutModal .modal-icon {
        ...
        background: linear-gradient(135deg, #6d8578 0%, #3B6255 100%) !important;
        ...
        box-shadow: 0 8px 20px rgba(59, 98, 85, 0.4) !important;
        position: relative !important;
        z-index: 1 !important;
    }
    ...
    #logoutModal .modal-btn.logout-confirm {
        background: linear-gradient(135deg, #6d8578 0%, #3B6255 100%) !important;
        color: #ffffff !important;
        box-shadow: 0 4px 12px rgba(59, 98, 85, 0.35) !important;
    }

    #logoutModal .modal-btn.logout-confirm:hover {
        background: linear-gradient(135deg, #5a6d63 0%, #2d4a3f 100%) !important;
        transform: translateY(-2px) !important;
        box-shadow: 0 6px 16px rgba(59, 98, 85, 0.45) !important;
    }
    ...
    #logoutModal .modal-btn.logout-confirm.success {
        background: linear-gradient(135deg, #8BA49A 0%, #3B6255 50%, #3B6255 100%) !important;
        transform: translateY(-2px) scale(1.05) !important;
        box-shadow: 0 12px 30px rgba(145, 179, 142, 0.4) !important;
    }
    ...
    <div class="main">
        <div class="page-header">
            ...
            <div style="display: flex; gap: 12px;">
                ...
                <a href="anonymous_dashboard_engineering.php" class="btn-link">
        ...
        <div id="contentArea">
            ...
            <div class="charts-grid">
                ...
                <div class="chart-card full-width">
                    <h3>
                        <i class="fas fa-graduation-cap"></i> LSPU Engineering Board Exam Passing Rate by Exam Type
    ...
    <script>
        ...
        function showLogoutSuccessMessage() {
            ...
            <div style="
              ...
              padding: 20px 32px;
              border-radius: 16px;
              box-shadow: 0 16px 40px rgba(145, 179, 142, 0.4);
              z-index: 10002;
              font-family: 'Inter', sans-serif;
              font-weight: 700;
              text-align: center;
        ...
        async function loadStatistics() {
            try {
                ...
                const response = await fetch('stats_anonymous_engineering.php');
            ...
            new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        backgroundColor: ['#8BA49A', '#64748b', '#D2C49E'],
                        borderWidth: 2,
                        borderColor: '#fff',
                        hoverOffset: 15,
                        hoverBorderWidth: 3
            ...
            new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        backgroundColor: [
                            'rgba(145, 179, 142, 0.75)',
                            'rgba(90, 133, 95, 0.75)'
                        ],
                        borderWidth: 2,
                        borderColor: '#fff',
                        hoverBorderWidth: 3,
                        hoverBorderColor: '#8BA49A'
                    }]
                },
                options: {
                    responsive: true,
        ...
        function renderPassingRateChart(data) {
            ...
            const gradientColors = passingRates.map((rate) => {
                if (rate >= 75) return 'rgba(145, 179, 142, 0.85)';  // Engineering green for high
                    ...
                    datasets: [
                        {
                            ...
                            data: passedData,
                            borderColor: '#8BA49A',
                            backgroundColor: 'rgba(145, 179, 142, 0.2)',
                            tension: 0.4,
                            fill: true,
                            borderWidth: 3,
                            pointRadius: 6,
                            pointHoverRadius: 9,
                            pointBackgroundColor: '#8BA49A',
            ...
            modal.innerHTML = `
                <div style="background: white; border-radius: 20px; padding: 40px; max-width: 700px; max-height: 90vh; overflow-y: auto; box-shadow: 0 25px 80px rgba(0,0,0,0.4);">
                    <h2 style="margin: 0 0 24px 0; font-size: 1.8rem; color: #0f1724; display: flex; align-items: center; gap: 12px;">
                        <i class="fas fa-chart-line" style="color: #8BA49A;"></i> Year ${year} Exam Trend
                    </h2>
                    
                    <div style="margin-bottom: 24px; padding: 20px; background: linear-gradient(135deg, #E2DFDA 0%, #CBDED3 100%); border-radius: 12px;">
                        <div style="display: flex; justify-content: space-between; margin-bottom: 12px; padding-bottom: 12px; border-bottom: 2px solid rgba(145, 179, 142, 0.3);">
                            ...
                            <span style="font-weight: 800; font-size: 1.3rem; color: #8BA49A;">${yearData.total}</span>
                        </div>
                        <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 12px; margin-top: 16px;">
                            <div style="background: white; padding: 16px; border-radius: 10px; box-shadow: 0 2px 8px rgba(0,0,0,0.08);">
                                ...
                                <div style="font-weight: 800; font-size: 1.5rem; color: #8BA49A;">${yearData.passed}</div>
                                <div style="font-size: 0.9rem; color: #8BA49A; font-weight: 600;">${passingRate}%</div>
                            </div>
                            <div style="background: white; padding: 16px; border-radius: 10px; box-shadow: 0 2px 8px rgba(0,0,0,0.08);">
                            ...
                            <div style="background: white; padding: 16px; border-radius: 10px; box-shadow: 0 2px 8px rgba(0,0,0,0.08);">
                                ...
                                <div style="font-weight: 800; font-size: 1.5rem; color: #D2C49E;">${yearData.conditional}</div>
                                <div style="font-size: 0.9rem; color: #D2C49E; font-weight: 600;">${conditionalRate}%</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div style="margin-bottom: 24px;">
                        <h3 style="margin: 0 0 16px 0; font-size: 1.1rem; color: #0f1724; display: flex; align-items: center; gap: 8px;">
                            <i class="fas fa-calendar-alt" style="color: #8BA49A;"></i> Exam Dates (${examDates.length})
                        </h3>
                        <div style="display: grid; gap: 8px; max-height: 200px; overflow-y: auto; padding: 12px; background: #f8fafc; border-radius: 10px;">
                            ${examDates.sort().map(date => `
                                <div style="background: white; padding: 10px 14px; border-radius: 8px; border-left: 3px solid #8BA49A; font-size: 0.95rem; font-weight: 600; color: #0f1724;">
                                    ${formatDate(date)}
                                </div>
                            `).join('')}
                        </div>
                    ...
                    <div style="padding: 20px; background: linear-gradient(135deg, #8BA49A 0%, #3B6255 100%); border-radius: 12px; color: white; margin-bottom: 20px;">
                    ...
                    <button onclick="this.closest('div[style*=fixed]').remove()" 
                        style="width: 100%; padding: 14px; background: #8BA49A; color: white; border: none; border-radius: 12px; font-weight: 700; cursor: pointer; font-size: 1.05rem; transition: all 0.3s;"
                        onmouseover="this.style.background='#3B6255'; this.style.transform='translateY(-2px)'"
                        onmouseout="this.style.background='#8BA49A'; this.style.transform='translateY(0)'">
                    ...
                    datasets: [
                        {
                            ...
                            backgroundColor: ['rgba(145, 179, 142, 0.85)', 'rgba(90, 133, 95, 0.85)'],
                            borderColor: ['#8BA49A', '#3B6255'],
                            borderWidth: 2,
                            borderRadius: 8,
                            hoverBackgroundColor: ['#8BA49A', '#3B6255'],
                            hoverBorderWidth: 3,
                            hoverBorderColor: '#fff'
                        },
                        {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        backgroundColor: totals.map((val, i) => {
                            ...
                            if (rate >= 70) return '#8BA49A';  // Engineering green for high passing rate
                            if (rate >= 50) return '#D2C49E';  // Light green for medium passing rate
                ...
                <div style="background: white; border-radius: 16px; padding: 32px; max-width: 500px; box-shadow: 0 20px 60px rgba(0,0,0,0.3);">
                    ...
                    <div style="margin-bottom: 16px;">
                        <div style="display: flex; justify-content: space-between; margin-bottom: 8px;">
                            ...
                            <span style="font-weight: 700; color: #8BA49A;">${typeData.total}</span>
                        </div>
                        <div style="display: flex; justify-content: space-between; margin-bottom: 8px;">
                        ...
                        <div style="display: flex; justify-content: space-between; margin-top: 16px; padding-top: 16px; border-top: 2px solid #e5e7eb;">
                            ...
                            <span style="font-weight: 800; font-size: 1.2rem; color: #8BA49A;">${passingRate}%</span>
                        </div>
                    </div>
                    <button onclick="this.closest('div[style*=fixed]').remove()" 
                        style="width: 100%; padding: 12px; background: #8BA49A; color: white; border: none; border-radius: 8px; font-weight: 600; cursor: pointer; font-size: 1rem;">
                        Close
                    </button>
                </div>
            `;
            ...
            modal.innerHTML = `
                <div style="background: white; border-radius: 16px; padding: 32px; max-width: 500px; box-shadow: 0 20px 60px rgba(0,0,0,0.3);">
                    ...
                    <div style="margin-bottom: 16px;">
                        <div style="display: flex; justify-content: space-between; margin-bottom: 8px;">
                            <span style="font-weight: 600;">Total Examinees:</span>
                            <span style="font-weight: 700; color: #8BA49A;">${dateData.total}</span>
                        </div>
                        <div style="display: flex; justify-content: space-between; margin-bottom: 8px;">
                            <span style="font-weight: 600;">Passed:</span>
                            <span style="font-weight: 700; color: #8BA49A;">${dateData.passed}</span>
                        </div>
                        <div style="display: flex; justify-content: space-between; margin-bottom: 8px;">
                            <span style="font-weight: 600;">Failed:</span>
                        ...
                        <div style="display: flex; justify-content: space-between; margin-bottom: 8px;">
                            <span style="font-weight: 600;">Conditional:</span>
                            <span style="font-weight: 700; color: #D2C49E;">${dateData.conditional}</span>
                        </div>
                        <div style="display: flex; justify-content: space-between; margin-top: 16px; padding-top: 16px; border-top: 2px solid #e5e7eb;">
                            <span style="font-weight: 700; font-size: 1.1rem;">Passing Rate:</span>
                            <span style="font-weight: 800; font-size: 1.2rem; color: #8BA49A;">${passingRate}%</span>
        ...
        function showChartInfo(chartId) {
            ...
            modal.innerHTML = `
                <div style="background: white; border-radius: 20px; padding: 40px; max-width: 700px; max-height: 85vh; overflow-y: auto; box-shadow: 0 25px 80px rgba(0,0,0,0.4); animation: slideUp 0.3s ease;">
                    <div style="display: flex; align-items: center; gap: 16px; margin-bottom: 24px; padding-bottom: 20px; border-bottom: 3px solid #8BA49A;">
                        <div style="width: 60px; height: 60px; background: linear-gradient(135deg, #8BA49A 0%, #3B6255 100%); border-radius: 15px; display: flex; align-items: center; justify-content: center; box-shadow: 0 4px 12px rgba(145, 179, 142, 0.4);">
                    ...
                    <div style="margin-bottom: 24px; padding: 20px; background: linear-gradient(135deg, #E2DFDA 0%, #CBDED3 100%); border-radius: 12px; border-left: 4px solid #8BA49A;">
                        <h3 style="margin: 0 0 12px 0; color: #0f1724; font-size: 1.2rem; font-weight: 700; display: flex; align-items: center; gap: 8px;">
                            <i class="fas fa-bullseye" style="color: #8BA49A;"></i> Purpose
                        </h3>
                    ...
                    <div style="margin-bottom: 24px;">
                        <h3 style="margin: 0 0 12px 0; color: #0f1724; font-size: 1.1rem; font-weight: 700; display: flex; align-items: center; gap: 8px;">
                            <i class="fas fa-align-left" style="color: #8BA49A;"></i> Description
                        </h3>
                    ...
                    <div style="margin-bottom: 24px;">
                        <h3 style="margin: 0 0 16px 0; color: #0f1724; font-size: 1.1rem; font-weight: 700; display: flex; align-items: center; gap: 8px;">
                            <i class="fas fa-star" style="color: #8BA49A;"></i> Key Features
                        </h3>
                        <ul style="margin: 0; padding-left: 0; list-style: none;">
                            ${info.features.map(feature => `
                                <li style="margin-bottom: 10px; padding: 12px 16px; background: #f8fafc; border-radius: 8px; border-left: 3px solid #8BA49A; color: #334155; font-size: 0.95rem;">
                    ...
                    <div style="padding: 20px; background: linear-gradient(135deg, #8BA49A 0%, #3B6255 100%); border-radius: 12px; color: white;">
                    ...
                    <button onclick="this.closest('div[style*=fixed]').remove()" 
                        style="width: 100%; margin-top: 24px; padding: 14px; background: #8BA49A; color: white; border: none; border-radius: 12px; font-weight: 700; cursor: pointer; font-size: 1.05rem; transition: all 0.3s;"
                        onmouseover="this.style.background='#3B6255'; this.style.transform='translateY(-2px)'; this.style.boxShadow='0 4px 12px rgba(145,179,142,0.4)'"
                        onmouseout="this.style.background='#8BA49A'; this.style.transform='translateY(0)'; this.style.boxShadow='none'">
                        <i class="fas fa-times-circle"></i> Close
                    </button>
                </div>
            `;
        ...
        function showYearDetails(year, yearData) {
            ...
            modal.innerHTML = `
                <div style="background: white; border-radius: 20px; padding: 40px; max-width: 600px; box-shadow: 0 25px 80px rgba(0,0,0,0.4);">
                    <h2 style="margin: 0 0 24px 0; font-size: 1.8rem; color: #0f1724; display: flex; align-items: center; gap: 12px;">
                        <i class="fas fa-calendar-year" style="color: #8BA49A;"></i> Year ${year} Performance Summary
                    </h2>
                    <div style="margin-bottom: 20px; padding: 20px; background: linear-gradient(135deg, #E2DFDA 0%, #CBDED3 100%); border-radius: 12px;">
                        <div style="display: flex; justify-content: space-between; margin-bottom: 12px; padding-bottom: 12px; border-bottom: 2px solid rgba(145, 179, 142, 0.3);">
                            <span style="font-weight: 700; font-size: 1.2rem;">Total Examinees:</span>
                            <span style="font-weight: 800; font-size: 1.3rem; color: #8BA49A;">${yearData.total}</span>
                        </div>
                    ...
                    <div style="margin-top: 24px; padding: 20px; background: linear-gradient(135deg, #e0f2f1 0%, #b2dfdb 100%); border-radius: 12px;">
                        ...
                        <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 16px;">
                            <div style="background: white; padding: 16px; border-radius: 10px; box-shadow: 0 2px 8px rgba(0,0,0,0.08);">
                                ...
                                <div style="font-weight: 800; font-size: 1.5rem; color: #8BA49A;">${yearData.first_timer || 0}</div>
                            ...
                            <div style="background: white; padding: 16px; border-radius: 10px; box-shadow: 0 2px 8px rgba(0,0,0,0.08);">
                                ...
                                <div style="font-weight: 800; font-size: 1.5rem; color: #3B6255;">${yearData.repeater || 0}</div>
                    ...
                    <div style="margin-top: 24px;">
                        <h3 style="margin: 0 0 16px 0; font-size: 1.1rem; color: #0f1724; display: flex; align-items: center; gap: 8px;">
                            <i class="fas fa-graduation-cap" style="color: #8BA49A;"></i> Board Exams Taken
                        </h3>
                        <div style="display: grid; gap: 12px;">
                            ${Object.keys(yearData.board_exams).map(examType => {
                                ...
                                return `
                                <div style="background: linear-gradient(135deg, #f8fafc 0%, #f1f5f9 100%); padding: 14px; border-radius: 10px; border-left: 4px solid #8BA49A;">
                                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 8px;">
                                        <span style="font-weight: 700; color: #0f1724; font-size: 0.95rem;">${examType}</span>
                                        <span style="font-weight: 800; color: #8BA49A; font-size: 1rem;">${examPassingRate}%</span>
                                    </div>
                                    <div style="display: flex; gap: 12px; font-size: 0.85rem;">
                                        <span style="color: #64748b;">Total: <strong>${examData.total}</strong></span>
                                        <span style="color: #8BA49A;">Passed: <strong>${examData.passed}</strong></span>
                                        <span style="color: #64748b;">Failed: <strong>${examData.failed}</strong></span>
                                        ${examData.conditional > 0 ? `<span style="color: #D2C49E;">Conditional: <strong>${examData.conditional}</strong></span>` : ''}
                                    </div>
                                </div>
                                `;
                            }).join('')}
                    ...
                    <div style="margin-top: 24px; padding: 20px; background: linear-gradient(135deg, #8BA49A 0%, #3B6255 100%); border-radius: 12px; color: white;">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            <span style="font-weight: 700; font-size: 1.2rem;">Overall Passing Rate</span>
                            <span style="font-weight: 900; font-size: 2rem;">${passingRate}%</span>
                        </div>
                    ...
                    <button onclick="this.closest('div[style*=fixed]').remove()" 
                        style="width: 100%; padding: 14px; background: #8BA49A; color: white; border: none; border-radius: 12px; font-weight: 700; cursor: pointer; font-size: 1.05rem; margin-top: 24px; transition: all 0.3s;"
                        onmouseover="this.style.background='#3B6255'; this.style.transform='translateY(-2px)'"
                        onmouseout="this.style.background='#8BA49A'; this.style.transform='translateY(0)'">
                        <i class="fas fa-times-circle"></i> Close
                    </button>
        ...
        async function exportToPDF() {
            ...
            loadingOverlay.innerHTML = `
                <div style="width: 80px; height: 80px; border: 5px solid rgba(145, 179, 142, 0.3); border-top-color: #8BA49A; border-radius: 50%; animation: spin 1s linear infinite;"></div>
