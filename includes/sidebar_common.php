...
?>
<div class="sidebar">
  <div class="logo">LSPU<br><span style="font-size:0.9em;font-weight:400;">Engineering</span></div>
  <div class="sidebar-nav">
    <a href="dashboard_engineering.php"
    ...
    <a href="add_board_passer_engineering.php"
    ...
    <a href="manage_data_engineering.php"
    ...
    <a href="import_data_engineering.php"
    ...
    (function(){
      try {
        ...
        function applyIconState(el){
          var icon = el.querySelector('i'); if(!icon) return;
        ...
        links.forEach(function(a){ applyIconState(a); a.addEventListener('click', function(){
          // optimistic UI: swap icons immediately; navigation will follow for normal links
          links.forEach(function(b){ b.classList.remove('active'); applyIconState(b); });
          a.classList.add('active'); applyIconState(a);
        }); });
      } catch(e) { /* no-op */ }
    })();
  </script>
