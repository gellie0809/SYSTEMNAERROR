...
?>
<div class="sidebar">
    <div class="logo">LSPU<br><span style="font-size:0.9em;font-weight:400;">College of Business Administration and
            Accountancy</span></div>
    <div class="sidebar-nav">
        <a href="dashboard_cbaa.php"
            class="<?php if(basename($_SERVER['PHP_SELF'])==='dashboard_engineering.php') echo 'active'; ?>"
            data-icon-default="fas fa-chart-pie" data-icon-active="fas fa-gauge">
            <i class="fas fa-chart-pie"></i> <span>Dashboard</span>
        </a>
        <a href="add_board_passer_cbaa.php"
            class="<?php if(basename($_SERVER['PHP_SELF'])==='add_board_passer_engineering.php') echo 'active'; ?>"
        ...
        <a href="manage_data_cbaa.php"
            class="<?php if(basename($_SERVER['PHP_SELF'])==='manage_data_engineering.php') echo 'active'; ?>"
            data-icon-default="fas fa-book" data-icon-active="fas fa-book-open">
            <i class="fas fa-book"></i> <span>Manage Data</span>
        </a>
        <a href="import_data_cbaa.php"
            class="<?php if(basename($_SERVER['PHP_SELF'])==='import_data_engineering.php') echo 'active'; ?>"
            data-icon-default="fas fa-upload" data-icon-active="fas fa-file-arrow-up">
            <i class="fas fa-upload"></i> <span>Import Data</span>
        </a>
        <a href="export_data_cbaa.php"
            class="<?php if(basename($_SERVER['PHP_SELF'])==='export_data_engineering.php') echo 'active'; ?>"
            data-icon-default="fas fa-download" data-icon-active="fas fa-file-arrow-down">
            <i class="fas fa-download"></i> <span>Export Data</span>
        </a>
        <a href="view_statistics_cbaa.php"
            class="<?php if(basename($_SERVER['PHP_SELF'])==='view_statistics_engineering.php') echo 'active'; ?>"
        ...
        <a href="testing_anonymous_data_cbaa.php"
            class="<?php if(basename($_SERVER['PHP_SELF'])==='testing_anonymous_data_cbaa.php' || basename($_SERVER['PHP_SELF'])==='anonymous_dashboard_cbaa.php') echo 'active'; ?>"
            data-icon-default="fas fa-flask" data-icon-active="fas fa-vial">
            <i class="fas fa-flask"></i> <span>Testing Anonymous Data</span>
        </a>
        <a href="view_anonymous_statistics_cbaa.php"
            class="<?php if(basename($_SERVER['PHP_SELF'])==='view_anonymous_statistics_cbaa.php') echo 'active'; ?>"
        ...
        <a href="prediction_cbaa_anonymous.php"
            class="<?php if(basename($_SERVER['PHP_SELF'])==='prediction_cbaa_anonymous.php') echo 'active'; ?>"
