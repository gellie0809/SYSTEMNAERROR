"""
Training Report Generator for CBAA Department
...
class CBAATrainingReportGenerator:
    def __init__(self):
        self.db_config = {
            'host': 'localhost',
            'database': 'project_db',
    ...
    def fetch_training_data(self):
        """Fetch all CBAA anonymous training data"""
    ...
    def generate_report(self):
        ...
        print("\n📄 Generating CBAA Training Report...")
        ...
        filename = f"{self.output_dir}/CBAA_Training_Report_{timestamp}.pdf"
        ...
        # Custom styles - CBAA Brown/Orange theme
        ...
        cover_table.setStyle(TableStyle([
            ...
            ('FONTSIZE', (0, 0), (-1, -1), 11),
            ('TEXTCOLOR', (0, 0), (0, -1), colors.HexColor('#763A12')),
        ...
        intro_text = """
        This report documents the complete machine learning training process for the CBAA (College of Business 
        Administration and Accountancy) Board Exam Prediction System. The system uses historical anonymous 
        board exam data to predict future passing rates using advanced regression algorithms. This AI-powered 
        prediction system aims to help the institution make data-driven decisions regarding board exam preparation 
        ...
        • Filtered only records from the CBAA department<br/><br/>
        ...
        feature_descriptions = {
            ...
            'is_Certified_Public_Accountant_Licensure_Exam_CPALE': 'Binary indicator for CPALE exam type',
        ...
        if metadata and 'metrics' in metadata:
            ...
            best_metrics_data = [
                ...
                ['Dataset Used', f"CBAA ({len(training_data)} records)", f"{training_data['exam_year'].min()}-{training_data['exam_year'].max()}"],
            ]
            
            best_table = Table(best_metrics_data, colWidths=[2*inch, 1.5*inch, 3.3*inch])
            best_table.setStyle(TableStyle([
                ('BACKGROUND', (0, 0), (-1, 0), colors.HexColor('#763A12')),
                ('TEXTCOLOR', (0, 0), (-1, 0), colors.whitesmoke),
                ('ALIGN', (0, 0), (-1, -1), 'LEFT'),
                ...
                ('GRID', (0, 0), (-1, -1), 1, colors.HexColor('#AA4C0A')),
            ]))
        ...
        the CBAA Board Exam Prediction System. The system was trained on {len(training_data)} historical records 
        ...
        <i>Report generated by LSPU CBAA AI Board Exam Prediction System</i><br/>
        <i>{report_date}</i>
        """
