...
<head>
    ...
    <title>Anonymous Data Statistics - Business Administration and Accountancy</title>
    ...
    <div class="main">
        <div class="page-header">
            ...
            <div style="display: flex; gap: 12px;">
                ...
                <a href="testing_anonymous_data_cbaa.php" class="btn-link">
                    <i class="fas fa-plus-circle"></i> Add Data
                </a>
                <a href="anonymous_dashboard_cbaa.php" class="btn-link">
    ...
    <script>
        ...
        async function loadStatistics() {
            try {
                ...
                const response = await fetch('stats_anonymous_cbaa.php');
