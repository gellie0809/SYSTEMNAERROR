...
<head>
    ...
    * {
    ...
    body::before {
        ...
        bottom: 0;
        background:
            radial-gradient(circle at 20% 20%, rgba(145, 179, 142, 0.1) 0%, transparent 50%),
            radial-gradient(circle at 80% 60%, rgba(90, 133, 95, 0.08) 0%, transparent 50%),
            radial-gradient(circle at 40% 80%, rgba(197, 220, 194, 0.1) 0%, transparent 50%);
        pointer-events: none;
        z-index: 0;
    }
    ...
    /* File Upload Styles */
    .upload-area {
        border: 3px dashed rgba(145, 179, 142, 0.4);
        border-radius: 20px;
        padding: 50px;
        text-align: center;
        ...
        position: relative;
        overflow: hidden;
        box-shadow: 0 8px 30px rgba(145, 179, 142, 0.1);
    }
    ...
    .upload-area::before {
        ...
        right: 0;
        bottom: 0;
        background: linear-gradient(135deg, rgba(145, 179, 142, 0.05) 0%, rgba(90, 133, 95, 0.03) 100%);
        opacity: 0;
    ...
    .upload-area:hover {
        border-color: #8BA49A;
        background: linear-gradient(145deg, rgba(255, 255, 255, 1) 0%, rgba(240, 249, 240, 0.95) 100%);
        transform: translateY(-4px) scale(1.01);
        box-shadow: 0 15px 45px rgba(145, 179, 142, 0.2);
    }
    ...
    .upload-area.dragover {
        border-color: #3B6255;
        background: linear-gradient(145deg, rgba(240, 249, 240, 0.98) 0%, rgba(224, 242, 227, 0.95) 100%);
        transform: scale(1.03);
        box-shadow: 0 20px 60px rgba(145, 179, 142, 0.3);
    }
    ...
    .upload-icon {
        ...
        filter: drop-shadow(0 4px 12px rgba(145, 179, 142, 0.3));
    }
    ...
    .upload-btn:hover {
        ...
        box-shadow: 0 12px 30px rgba(145, 179, 142, 0.45);
    }
    ...
    /* Import Stats */
    .import-stats {
        background: linear-gradient(145deg, rgba(255, 255, 255, 0.9) 0%, rgba(240, 249, 240, 0.8) 100%);
        border-radius: 20px;
        padding: 30px;
        margin-top: 30px;
    ...
    .template-btn:hover {
        ...
        box-shadow: 0 12px 35px rgba(59, 98, 85, 0.5);
    }
    ...
    .btn.btn-primary {
        ...
        box-shadow: 0 6px 20px rgba(139, 164, 154, 0.4) !important;
        transition: all 0.3s ease !important;
        cursor: pointer !important;
    }

    .btn.btn-primary:hover:not(:disabled) {
        background: linear-gradient(135deg, #3B6255 0%, #8BA49A 100%) !important;
        transform: translateY(-3px) scale(1.02) !important;
        box-shadow: 0 12px 35px rgba(59, 98, 85, 0.5) !important;
    }

    .btn.btn-primary:disabled {
        background: linear-gradient(135deg, #cbd5e0 0%, #94a3b8 100%) !important;
    ...
    #importConfirmModal.modal {
        ...
        background: linear-gradient(135deg, rgba(90, 133, 95, 0.95) 0%, rgba(145, 179, 142, 0.9) 100%) !important;
    ...
    #importConfirmModal .modal-content {
        ...
        box-shadow:
            0 25px 50px rgba(145, 179, 142, 0.4),
        ...
        border: 3px solid rgba(145, 179, 142, 0.2) !important;
    ...
    #importConfirmModal .modal-content::before {
        ...
        background: linear-gradient(135deg, #8BA49A 0%, #3B6255 25%, #2d5a2e 50%, #3B6255 75%, #8BA49A 100%) !important;
    ...
    #importConfirmModal .modal-header {
        ...
        border: 2px solid rgba(145, 179, 142, 0.15) !important;
        position: relative !important;
        overflow: hidden !important;
        box-shadow: 0 8px 25px rgba(145, 179, 142, 0.1) !important;
    }
    ...
    #importConfirmModal .modal-icon {
        ...
        overflow: hidden !important;
        box-shadow:
            0 15px 35px rgba(145, 179, 142, 0.4),
    ...
    @keyframes iconPulse {
        ...
        100% {
            transform: scale(1);
            box-shadow: 0 15px 35px rgba(145, 179, 142, 0.4);
        }

        50% {
            transform: scale(1.05);
            box-shadow: 0 20px 40px rgba(145, 179, 142, 0.5);
        }
    }
    ...
    .import-confirm {
        background: linear-gradient(135deg, #8BA49A 0%, #3B6255 100%) !important;
        border: 2px solid rgba(145, 179, 142, 0.3) !important;
        color: white !important;
    ...
    .import-confirm:hover {
        ...
        border-color: rgba(90, 133, 95, 0.5) !important;
        transform: translateY(-2px) scale(1.02) !important;
        box-shadow: 0 12px 30px rgba(145, 179, 142, 0.45) !important;
    }
    ...
    #importConfirmModal .modal-text {
        ...
        margin: 20px 32px !important;
        text-align: center !important;
        background: rgba(145, 179, 142, 0.05) !important;
        padding: 16px !important;
        border-radius: 12px !important;
        border: 1px solid rgba(145, 179, 142, 0.1) !important;
    }
    ...
    #logoutModal .modal-header {
        ...
        position: relative !important;
        overflow: hidden !important;
        box-shadow: 0 8px 25px rgba(145, 179, 142, 0.2) !important;
    }
    ...
    #logoutModal .modal-header::after {
        ...
        background: linear-gradient(135deg, rgba(145, 179, 142, 0.15) 0%, rgba(168, 197, 165, 0.08) 100%) !important;
    ...
    #logoutModal .modal-icon {
        ...
        box-shadow:
            0 20px 40px rgba(90, 133, 95, 0.45),
            0 0 0 4px rgba(255, 255, 255, 0.8),
            0 0 0 6px rgba(145, 179, 142, 0.25) !important;
        position: relative !important;
        z-index: 1 !important;
        ...
        <div class="card">
            ...
            <div class="card-content">
                ...
                <div class="import-stats">
                    <h3 style="color: #3B6255; margin-bottom: 20px; font-weight: 700;">Import Results</h3>
