...
// Load board exam types (Criminal Justice Education only, exclude deleted)
$board_exam_types = [];
$type_stmt = $conn->prepare("SELECT id, exam_type_name FROM board_exam_types WHERE department='Criminal Justice Education' AND (is_deleted IS NULL OR is_deleted = 0) ORDER BY exam_type_name");
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add_anonymous'])) {
    ...
    if (empty($errors)) {
        ...
        $stmt = $conn->prepare("INSERT INTO anonymous_board_passers (board_exam_type, board_exam_date, exam_type, result, department) VALUES (?, ?, ?, ?, 'Criminal Justice Education')");
        if ($stmt) {
...
<head>
    ...
    <title>Testing Anonymous Data - Criminal Justice Education</title>
    ...
    <style>
        ...
        * {
        ...
        .topbar {
            ...
            padding: 0 40px;
            box-shadow: 0 4px 25px rgba(211, 47, 47, 0.25);
            z-index: 50;
        }
    ...
    #logoutModal .modal-content {
        ...
        box-shadow:
            0 32px 64px -12px rgba(211, 47, 47, 0.25),
    ...
    #logoutModal .modal-content::before {
        ...
        background: linear-gradient(135deg, #C62828 0%, #D32F2F 25%, #E63946 50%, #D32F2F 75%, #C62828 100%) !important;
    ...
    #logoutModal .modal-header::before {
        ...
        background: linear-gradient(90deg, #C62828 0%, #D32F2F 50%, #E63946 100%) !important;
    ...
    #logoutModal .modal-header::after {
        ...
        background: linear-gradient(135deg, rgba(211, 47, 47, 0.1) 0%, rgba(230, 57, 70, 0.05) 100%) !important;
    ...
    #logoutModal .modal-icon {
        ...
        background: linear-gradient(135deg, #C62828 0%, #D32F2F 50%, #800020 100%) !important;
        border-radius: 50% !important;
        display: flex !important;
        align-items: center !important;
        justify-content: center !important;
    ...
    #logoutModal .modal-btn.logout-confirm:hover {
        background: linear-gradient(135deg, #800020 0%, #C62828 50%, #D32F2F 100%) !important;
...
<body>
    ...
    <div class="topbar">
        <div class="dashboard-title">Criminal Justice Education Admin Dashboard</div>
    ...
    <div class="main">
        <div class="page-header">
            ...
            <a href="anonymous_dashboard_ccje.php" class="view-dashboard-btn">
