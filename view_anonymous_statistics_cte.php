...
<head>
    ...
    <title>Anonymous Data Statistics - Teacher Education</title>
 ...
 /* CTE-specific sidebar color overrides */
    ...
    .logout-btn:hover {
        ...
        .page-header {
            ...
            border-radius: 20px;
            box-shadow: 0 8px 32px rgba(70, 99, 172, 0.15);
            backdrop-filter: blur(10px);
            border: 1px solid rgba(70, 99, 172, 0.2);
        }
        ...
        .btn-link {
            background: linear-gradient(135deg, #4663ac 0%, #7a9d76 50%, #c1d8f0 100%);
            color: #fff;
            border: none;
            border-radius: 12px;
            padding: 12px 24px;
            ...
            align-items: center;
            gap: 8px;
            box-shadow: 0 4px 15px rgba(70, 99, 172, 0.3);
            position: relative;
            overflow: hidden;
        }
        ...
        .chart-card {
            ...
            padding: 32px;
            box-shadow: 
                0 10px 40px rgba(70, 99, 172, 0.12),
        ...
        .chart-card::before {
            ...
            right: 0;
            height: 4px;
            background: linear-gradient(90deg, #4663ac, #c1d8f0, #4663ac);
        ...
        .chart-card:hover {
            ...
            box-shadow: 
                0 15px 50px rgba(70, 99, 172, 0.2),
                0 5px 15px rgba(0, 0, 0, 0.1);
            border-color: rgba(70, 99, 172, 0.3);
        }
        ...
        .chart-card h3 {
            ...
            gap: 12px;
            padding-bottom: 16px;
            border-bottom: 2px solid rgba(70, 99, 172, 0.15);
        }
        ...
        .info-btn:hover {
            transform: scale(1.1);
            box-shadow: 0 4px 12px rgba(70, 99, 172, 0.5);
        }
    ...
    #logoutModal .modal-content {
        ...
        box-shadow:
            0 32px 64px -12px rgba(70, 99, 172, 0.25),
    ...
    #logoutModal .modal-header {
        ...
        background: linear-gradient(135deg, #FDFDF9 0%, #c1d8f0 100%) !important;
        padding: 32px 28px !important;
        border-radius: 20px !important;
        border: 2px solid #c5dcc2 !important;
        position: relative !important;
        overflow: hidden !important;
        box-shadow: 0 8px 25px rgba(70, 99, 172, 0.15) !important;
    }
    ...
    #logoutModal .modal-header::after {
        ...
        background: linear-gradient(135deg, rgba(70, 99, 172, 0.1) 0%, rgba(193, 216, 240, 0.05) 100%) !important;
    ...
    #logoutModal .modal-icon {
        ...
        background: linear-gradient(135deg, #c1d8f0 0%, #4663ac 50%, #2d5a2e 100%) !important;
        border-radius: 50% !important;
        display: flex !important;
        align-items: center !important;
        justify-content: center !important;
        ...
        box-shadow:
            0 20px 40px rgba(70, 99, 172, 0.4),
            0 0 0 4px rgba(255, 255, 255, 0.8),
            0 0 0 6px rgba(70, 99, 172, 0.2) !important;
        position: relative !important;
        z-index: 1 !important;
    ...
    @keyframes iconPulse {
        0%, 100% {
            box-shadow:
                0 20px 40px rgba(70, 99, 172, 0.4),
                0 0 0 4px rgba(255, 255, 255, 0.8),
                0 0 0 6px rgba(70, 99, 172, 0.2);
            transform: scale(1);
        }
        50% {
            box-shadow:
                0 25px 50px rgba(70, 99, 172, 0.6),
                0 0 0 6px rgba(255, 255, 255, 0.9),
                0 0 0 8px rgba(70, 99, 172, 0.3);
    ...
    #logoutModal .modal-title {
        ...
        background: linear-gradient(135deg, #c1d8f0 0%, #2d5a2e 100%) !important;
    ...
    #logoutModal .modal-btn.logout-confirm:hover {
        background: linear-gradient(135deg, #2d5a2e 0%, #c1d8f0 50%, #4663ac 100%) !important;
    ...
    #logoutModal .modal-btn.logout-confirm.success {
        background: linear-gradient(135deg, #4663ac 0%, #c1d8f0 50%, #3d5a40 100%) !important;
...
<body>
    ...
    <div class="topbar">
        <div class="dashboard-title">Anonymous Data Statistics - Teacher Education</div>
    ...
    <div class="main">
        <div class="page-header">
            ...
            <div style="display: flex; gap: 12px;">
                ...
                <a href="testing_anonymous_data_CTE.php" class="btn-link">
                    <i class="fas fa-plus-circle"></i> Add Data
                </a>
                <a href="anonymous_dashboard_CTE.php" class="btn-link">
    ...
    <script>
        ...
        async function loadStatistics() {
            try {
                ...
                const response = await fetch('stats_anonymous_CTE.php');
                ...
                // Display charts even with no data
                try {
                    renderResultsChart(data);
            ...
            new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        backgroundColor: ['#4663ac', '#64748b', '#c1d8f0'],
                        borderWidth: 2,
                        borderColor: '#fff',
                        hoverOffset: 15,
                        hoverBorderWidth: 3
            ...
            new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        backgroundColor: [
                            'rgba(70, 99, 172, 0.75)',
                            'rgba(107, 141, 214, 0.75)'
                        ],
                        borderWidth: 2,
                        borderColor: '#fff',
                        hoverBorderWidth: 3,
                        hoverBorderColor: '#4663ac'
                    }]
                },
                options: {
                    responsive: true,
        ...
        function renderPassingRateChart(data) {
            ...
            const gradientColors = passingRates.map((rate) => {
                if (rate >= 75) return 'rgba(70, 99, 172, 0.85)';  // CTE blue for high
                if (rate >= 50) return 'rgba(107, 141, 214, 0.85)';  // Light blue for medium
                    ...
                    datasets: [
                        {
                            ...
                            data: passedData,
                            borderColor: '#4663ac',
                            backgroundColor: 'rgba(70, 99, 172, 0.2)',
                            tension: 0.4,
                            fill: true,
                            borderWidth: 3,
                            pointRadius: 6,
            ...
            modal.innerHTML = `
                <div style="background: white; border-radius: 20px; padding: 40px; max-width: 700px; max-height: 90vh; overflow-y: auto; box-shadow: 0 25px 80px rgba(0,0,0,0.4);">
                    <h2 style="margin: 0 0 24px 0; font-size: 1.8rem; color: #0f1724; display: flex; align-items: center; gap: 12px;">
                        <i class="fas fa-chart-line" style="color: #4663ac;"></i> Year ${year} Exam Trend
                    </h2>
                    
                    <div style="margin-bottom: 24px; padding: 20px; background: linear-gradient(135deg, #E8F0FC 0%, #D6E4F9 100%); border-radius: 12px;">
                        <div style="display: flex; justify-content: space-between; margin-bottom: 12px; padding-bottom: 12px; border-bottom: 2px solid rgba(70, 99, 172, 0.3);">
                            <span style="font-weight: 700; font-size: 1.2rem;">Total Examinees:</span>
                            <span style="font-weight: 800; font-size: 1.3rem; color: #4663ac;">${yearData.total}</span>
                        </div>
                        <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 12px; margin-top: 16px;">
                            <div style="background: white; padding: 16px; border-radius: 10px; box-shadow: 0 2px 8px rgba(0,0,0,0.08);">
                                ...
                                <div style="font-weight: 800; font-size: 1.5rem; color: #4663ac;">${yearData.passed}</div>
                                <div style="font-size: 0.9rem; color: #4663ac; font-weight: 600;">${passingRate}%</div>
                            </div>
                            <div style="background: white; padding: 16px; border-radius: 10px; box-shadow: 0 2px 8px rgba(0,0,0,0.08);">
                            ...
                            <div style="background: white; padding: 16px; border-radius: 10px; box-shadow: 0 2px 8px rgba(0,0,0,0.08);">
                                ...
                                <div style="font-weight: 800; font-size: 1.5rem; color: #c1d8f0;">${yearData.conditional}</div>
                                <div style="font-size: 0.9rem; color: #c1d8f0; font-weight: 600;">${conditionalRate}%</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div style="margin-bottom: 24px;">
                        <h3 style="margin: 0 0 16px 0; font-size: 1.1rem; color: #0f1724; display: flex; align-items: center; gap: 8px;">
                            <i class="fas fa-calendar-alt" style="color: #4663ac;"></i> Exam Dates (${examDates.length})
                        </h3>
                        <div style="display: grid; gap: 8px; max-height: 200px; overflow-y: auto; padding: 12px; background: #f8fafc; border-radius: 10px;">
                            ${examDates.sort().map(date => `
                                <div style="background: white; padding: 10px 14px; border-radius: 8px; border-left: 3px solid #4663ac; font-size: 0.95rem; font-weight: 600; color: #0f1724;">
                                    ${formatDate(date)}
                                </div>
                            `).join('')}
                        </div>
                    ...
                    <div style="padding: 20px; background: linear-gradient(135deg, #4663ac 0%, #c1d8f0 100%); border-radius: 12px; color: white; margin-bottom: 20px;">
                    ...
                    <button onclick="this.closest('div[style*=fixed]').remove()" 
                        style="width: 100%; padding: 14px; background: #4663ac; color: white; border: none; border-radius: 12px; font-weight: 700; cursor: pointer; font-size: 1.05rem; transition: all 0.3s;"
                        onmouseover="this.style.background='#c1d8f0'; this.style.transform='translateY(-2px)'"
                        onmouseout="this.style.background='#4663ac'; this.style.transform='translateY(0)'">
                    ...
                    datasets: [
                        {
                            ...
                            backgroundColor: ['rgba(70, 99, 172, 0.85)', 'rgba(107, 141, 214, 0.85)'],
                            borderColor: ['#4663ac', '#6B8DD6'],
                            borderWidth: 2,
                            borderRadius: 8,
                            hoverBackgroundColor: ['#4663ac', '#6B8DD6'],
                            hoverBorderWidth: 3,
                            hoverBorderColor: '#fff'
                        },
                        {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        backgroundColor: totals.map((val, i) => {
                            ...
                            if (rate >= 70) return '#4663ac';  // CTE blue for high passing rate
                            if (rate >= 50) return '#c1d8f0';  // Light blue for medium passing rate
                ...
                <div style="background: white; border-radius: 16px; padding: 32px; max-width: 500px; box-shadow: 0 20px 60px rgba(0,0,0,0.3);">
                    ...
                    <div style="margin-bottom: 16px;">
                        <div style="display: flex; justify-content: space-between; margin-bottom: 8px;">
                            ...
                            <span style="font-weight: 700; color: #4663ac;">${typeData.total}</span>
                        </div>
                        <div style="display: flex; justify-content: space-between; margin-bottom: 8px;">
                        ...
                        <div style="display: flex; justify-content: space-between; margin-bottom: 8px;">
                            ...
                            <span style="font-weight: 700; color: #4663ac;">${typeData.conditional}</span>
                        </div>
                        <div style="display: flex; justify-content: space-between; margin-top: 16px; padding-top: 16px; border-top: 2px solid #e5e7eb;">
                            ...
                            <span style="font-weight: 800; font-size: 1.2rem; color: #4663ac;">${passingRate}%</span>
                        </div>
                    </div>
                    <button onclick="this.closest('div[style*=fixed]').remove()" 
                        style="width: 100%; padding: 12px; background: #4663ac; color: white; border: none; border-radius: 8px; font-weight: 600; cursor: pointer; font-size: 1rem;">
                        Close
                    </button>
                </div>
            `;
            ...
            modal.innerHTML = `
                <div style="background: white; border-radius: 16px; padding: 32px; max-width: 500px; box-shadow: 0 20px 60px rgba(0,0,0,0.3);">
                    ...
                    <div style="margin-bottom: 16px;">
                        <div style="display: flex; justify-content: space-between; margin-bottom: 8px;">
                            <span style="font-weight: 600;">Total Examinees:</span>
                            <span style="font-weight: 700; color: #4663ac;">${dateData.total}</span>
                        </div>
                        <div style="display: flex; justify-content: space-between; margin-bottom: 8px;">
                            <span style="font-weight: 600;">Passed:</span>
                            <span style="font-weight: 700; color: #4663ac;">${dateData.passed}</span>
                        </div>
                        <div style="display: flex; justify-content: space-between; margin-bottom: 8px;">
                            <span style="font-weight: 600;">Failed:</span>
                        ...
                        <div style="display: flex; justify-content: space-between; margin-bottom: 8px;">
                            <span style="font-weight: 600;">Conditional:</span>
                            <span style="font-weight: 700; color: #c1d8f0;">${dateData.conditional}</span>
                        </div>
                        <div style="display: flex; justify-content: space-between; margin-top: 16px; padding-top: 16px; border-top: 2px solid #e5e7eb;">
                            <span style="font-weight: 700; font-size: 1.1rem;">Passing Rate:</span>
                            <span style="font-weight: 800; font-size: 1.2rem; color: #4663ac;">${passingRate}%</span>
            ...
            modal.innerHTML = `
                <div style="background: white; border-radius: 20px; padding: 40px; max-width: 700px; max-height: 85vh; overflow-y: auto; box-shadow: 0 25px 80px rgba(0,0,0,0.4); animation: slideUp 0.3s ease;">
                    <div style="display: flex; align-items: center; gap: 16px; margin-bottom: 24px; padding-bottom: 20px; border-bottom: 3px solid #4663ac;">
                        <div style="width: 60px; height: 60px; background: linear-gradient(135deg, #4663ac 0%, #c1d8f0 100%); border-radius: 15px; display: flex; align-items: center; justify-content: center; box-shadow: 0 4px 12px rgba(70, 99, 172, 0.4);">
                    ...
                    <div style="margin-bottom: 24px;">
                        <h3 style="margin: 0 0 12px 0; color: #0f1724; font-size: 1.1rem; font-weight: 700; display: flex; align-items: center; gap: 8px;">
                            <i class="fas fa-align-left" style="color: #4663ac;"></i> Description
                        </h3>
                    ...
                    <div style="margin-bottom: 24px;">
                        <h3 style="margin: 0 0 16px 0; color: #0f1724; font-size: 1.1rem; font-weight: 700; display: flex; align-items: center; gap: 8px;">
                            <i class="fas fa-star" style="color: #4663ac;"></i> Key Features
                        </h3>
                        <ul style="margin: 0; padding-left: 0; list-style: none;">
                            ${info.features.map(feature => `
                                <li style="margin-bottom: 10px; padding: 12px 16px; background: #f8fafc; border-radius: 8px; border-left: 3px solid #4663ac; color: #334155; font-size: 0.95rem;">
                                    <i class="fas fa-check-circle" style="color: #4663ac; margin-right: 8px;"></i>${feature}
                                </li>
                            `).join('')}
                        </ul>
                    </div>
                    ...
                    <div style="margin-bottom: 24px;">
                        <h3 style="margin: 0 0 16px 0; color: #0f1724; font-size: 1.1rem; font-weight: 700; display: flex; align-items: center; gap: 8px;">
                            <i class="fas fa-lightbulb" style="color: #4663ac;"></i> Insights You Can Gain
                        </h3>
                        <ul style="margin: 0; padding-left: 0; list-style: none;">
                            ${info.insights.map(insight => `
                                <li style="margin-bottom: 10px; padding: 12px 16px; background: #E8F0FC; border-radius: 8px; border-left: 3px solid #4663ac; color: #334155; font-size: 0.95rem;">
                                    <i class="fas fa-arrow-right" style="color: #4663ac; margin-right: 8px;"></i>${insight}
                                </li>
                            `).join('')}
                        </ul>
                    </div>

                    <div style="padding: 20px; background: linear-gradient(135deg, #4663ac 0%, #c1d8f0 100%); border-radius: 12px; color: white;">
                    ...
                    <button onclick="this.closest('div[style*=fixed]').remove()" 
                        ...
                        onmouseover="this.style.background='#c1d8f0'; this.style.transform='translateY(-2px)'; this.style.boxShadow='0 4px 12px rgba(145,179,142,0.4)'"
        ...
        function showYearDetails(year, yearData) {
            ...
            modal.innerHTML = `
                <div style="background: white; border-radius: 20px; padding: 40px; max-width: 600px; box-shadow: 0 25px 80px rgba(0,0,0,0.4);">
                    <h2 style="margin: 0 0 24px 0; font-size: 1.8rem; color: #0f1724; display: flex; align-items: center; gap: 12px;">
                        <i class="fas fa-calendar-year" style="color: #4663ac;"></i> Year ${year} Performance Summary
                    </h2>
                    <div style="margin-bottom: 20px; padding: 20px; background: linear-gradient(135deg, #E8F0FC 0%, #D6E4F9 100%); border-radius: 12px;">
                        <div style="display: flex; justify-content: space-between; margin-bottom: 12px; padding-bottom: 12px; border-bottom: 2px solid rgba(70, 99, 172, 0.3);">
                            <span style="font-weight: 700; font-size: 1.2rem;">Total Examinees:</span>
                            <span style="font-weight: 800; font-size: 1.3rem; color: #4663ac;">${yearData.total}</span>
                        </div>
                    ...
                    <div style="margin-top: 24px; padding: 20px; background: linear-gradient(135deg, #e0f2f1 0%, #b2dfdb 100%); border-radius: 12px;">
                        ...
                        <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 16px;">
                            <div style="background: white; padding: 16px; border-radius: 10px; box-shadow: 0 2px 8px rgba(0,0,0,0.08);">
                                ...
                                <div style="font-weight: 800; font-size: 1.5rem; color: #4663ac;">${yearData.first_timer || 0}</div>
                            ...
                            <div style="background: white; padding: 16px; border-radius: 10px; box-shadow: 0 2px 8px rgba(0,0,0,0.08);">
                                ...
                                <div style="font-weight: 800; font-size: 1.5rem; color: #c1d8f0;">${yearData.repeater || 0}</div>
                    ...
                    <div style="margin-top: 24px;">
                        <h3 style="margin: 0 0 16px 0; font-size: 1.1rem; color: #0f1724; display: flex; align-items: center; gap: 8px;">
                            <i class="fas fa-graduation-cap" style="color: #4663ac;"></i> Board Exams Taken
                        </h3>
                        <div style="display: grid; gap: 12px;">
                            ${Object.keys(yearData.board_exams).map(examType => {
                                ...
                                return `
                                <div style="background: linear-gradient(135deg, #f8fafc 0%, #f1f5f9 100%); padding: 14px; border-radius: 10px; border-left: 4px solid #4663ac;">
                                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 8px;">
                                        <span style="font-weight: 700; color: #0f1724; font-size: 0.95rem;">${examType}</span>
                                        <span style="font-weight: 800; color: #4663ac; font-size: 1rem;">${examPassingRate}%</span>
                                    </div>
                                    <div style="display: flex; gap: 12px; font-size: 0.85rem;">
                                        <span style="color: #64748b;">Total: <strong>${examData.total}</strong></span>
                                        <span style="color: #4663ac;">Passed: <strong>${examData.passed}</strong></span>
                                        <span style="color: #64748b;">Failed: <strong>${examData.failed}</strong></span>
                                        ${examData.conditional > 0 ? `<span style="color: #c1d8f0;">Conditional: <strong>${examData.conditional}</strong></span>` : ''}
                                    </div>
                                </div>
                                `;
                            }).join('')}
                    ...
                    <div style="margin-top: 24px; padding: 20px; background: linear-gradient(135deg, #4663ac 0%, #c1d8f0 100%); border-radius: 12px; color: white;">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            <span style="font-weight: 700; font-size: 1.2rem;">Overall Passing Rate</span>
                            <span style="font-weight: 900; font-size: 2rem;">${passingRate}%</span>
                        </div>
                    ...
                    <button onclick="this.closest('div[style*=fixed]').remove()" 
                        style="width: 100%; padding: 14px; background: #4663ac; color: white; border: none; border-radius: 12px; font-weight: 700; cursor: pointer; font-size: 1.05rem; margin-top: 24px; transition: all 0.3s;"
                        onmouseover="this.style.background='#c1d8f0'; this.style.transform='translateY(-2px)'"
                        onmouseout="this.style.background='#4663ac'; this.style.transform='translateY(0)'">
                        <i class="fas fa-times-circle"></i> Close
                    </button>
        ...
        async function exportToPDF() {
            ...
            loadingOverlay.innerHTML = `
                <div style="width: 80px; height: 80px; border: 5px solid rgba(70, 99, 172, 0.3); border-top-color: #4663ac; border-radius: 50%; animation: spin 1s linear infinite;"></div>
