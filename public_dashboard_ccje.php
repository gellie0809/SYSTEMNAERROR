        ...
        <div class="info-modal">
            ...
            <div class="info-modal-body">
                ...
                <div class="data-source-box">
                    ...
                    <p>All visualizations are generated from <strong>anonymous board examination records</strong> stored in the LSPU Board Performance System database. Data includes examination results from <?php echo $year_range; ?>, covering all licensure examinations under the College of Criminal Justice Education. Personal identifying information is not displayed to protect student privacy. Data is updated as new examination results become available.</p>
                </div>
            </div>
        </div>
    </div>
