...
20'%3e%3cpath stroke='%236b7280' stroke-linecap='round' stroke-linejoin='round' stroke-width='1.5' d='m6 8 4 4
4-4'/%3e%3c/svg%3e");
...
<body>
    ...
    <div class="main-content">
        ...
        <div
            style="background: #fed7d7; border: 1px solid #fc8181; color: #c53030; padding: 12px 16px; border-radius: 8px; margin-bottom: 20px; text-align: center;">
            <?php
          switch($_GET['error']) {
            case 'missing_fields':
        ...
        <div
            style="background: #c6f6d5; border: 1px solid #68d391; color: #2f855a; padding: 12px 16px; border-radius: 8px; margin-bottom: 20px; text-align: center;">
                            ...
                            <div class="form-group full-width">
                                ...
                                <div class="input-wrapper">
                                    <select id="board_exam_type" name="board_exam_type" required>
                                        ...
                                        <option value="Registered Electrical Engineer Licensure Exam (REELE)">Registered
                                            Electrical Engineer Licensure Exam (REELE)</option>
                                        <option value="Registered Master Electrician (RME)">Registered Master
                                            Electrician (RME)</option>
                                    </select>
        ...
        <div class="modal-content">
            <div class="modal-text">
                <div style="display: flex; align-items: center; justify-content: center; margin-bottom: 16px;">
                    <div
                        style="width: 60px; height: 60px; background: linear-gradient(135deg, #3182ce 0%, #2c5aa0 100%); border-radius: 50%; display: flex; align-items: center; justify-content: center; color: white; font-size: 1.5rem;">
            ...
            <div class="modal-buttons">
                <button id="confirmYes" class="modal-btn"
                    style="background: linear-gradient(135deg, #3182ce 0%, #2c5aa0 100%); color: #fff; padding: 12px 32px; font-weight: 600;">Yes,
                    Add</button>
                <button id="confirmNo" class="modal-btn"
                    style="background: #e2e8f0; color: #4a5568; padding: 12px 32px; font-weight: 600;">Cancel</button>
            </div>
        </div>
    </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (form) {
            form.addEventListener('submit', function(e) {
                ...
                if (!firstName || !lastName || !sex || !course || !yearGraduated || !boardExamDate || !
                    result || !examType || !boardExamType) {
        ...
        document.getElementById('confirmYes').onclick = function() {
            ...
            const fields = [{
                ...
                {
                    name: 'board_exam_type',
                    value: formData.boardExamType
                }
            ];
