...
// Load board exam types (Arts and Sciences only, exclude deleted)
$board_exam_types = [];
$type_stmt = $conn->prepare("SELECT id, exam_type_name FROM board_exam_types WHERE department='Arts and Sciences' AND (is_deleted IS NULL OR is_deleted = 0) ORDER BY exam_type_name");
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add_anonymous'])) {
    ...
    if (empty($errors)) {
        ...
        $stmt = $conn->prepare("INSERT INTO anonymous_board_passers (board_exam_type, board_exam_date, exam_type, result, department) VALUES (?, ?, ?, ?, 'Arts and Sciences')");
        if ($stmt) {
...
<head>
    ...
    <title>Testing Anonymous Data - Arts and Sciences</title>
    ...
    #logoutModal .modal-content::before {
        ...
        background: linear-gradient(135deg, #C75B9B 0%, #FF99CC 25%, #FEB3DD 50%, #FF99CC 75%, #C75B9B 100%) !important;
    ...
    #logoutModal .modal-header::before {
        ...
        background: linear-gradient(90deg, #C75B9B 0%, #FF99CC 50%, #FEB3DD 100%) !important;
    ...
    #logoutModal .modal-icon {
        ...
        background: linear-gradient(135deg, #C75B9B 0%, #FF99CC 50%, #FEB3DD 100%) !important;
        border-radius: 50% !important;
        display: flex !important;
        align-items: center !important;
        justify-content: center !important;
    ...
    #logoutModal .modal-icon::before {
        ...
        background: linear-gradient(135deg, #FEB3DD, #FF99CC, #C75B9B) !important;
        border-radius: 50% !important;
        z-index: -1 !important;
    ...
    #logoutModal .modal-title {
        ...
        background: linear-gradient(135deg, #C75B9B 0%, #4A1942 100%) !important;
    ...
    #logoutModal .modal-btn.logout-confirm:hover {
        background: linear-gradient(135deg, #FEB3DD 0%, #FF99CC 50%, #C75B9B 100%) !important;
    ...
    #logoutModal .modal-btn.logout-confirm.success {
        background: linear-gradient(135deg, #FF99CC 0%, #C75B9B 50%, #FEB3DD 100%) !important;
...
<body>
    ...
    <div class="main">
        <div class="page-header">
            ...
            <a href="anonymous_dashboard_CAS.php" class="view-dashboard-btn">
