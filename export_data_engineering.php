...
<body>
      ...
      <div class="card-content">
        ...
        <div class="export-options">
          <div class="export-card">
            ...
            <p class="export-description">
              Download data in CSV format with properly formatted dates (compatible with Excel and Google Sheets)
            </p>
        ...
        <div class="export-info">
          <div class="info-card">
            ...
            <ul>
              <li><strong>CSV Format:</strong> Properly formatted dates (YYYY-MM-DD) to prevent hashtag display issues</li>
              <li><strong>Data Included:</strong> Name, Course, Graduation Year, Board Exam Date, Result, Exam Type</li>
  ...
  <script>
    ...
    function showComingSoon(format) {
      alert(`${format} export feature is coming soon! For now, please use the CSV export which includes properly formatted dates.`);
    }
  </script>
</body>
</html>
