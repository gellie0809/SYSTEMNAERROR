<?php
// PUBLIC Dashboard - No login required - College of Business Administration and Accountancy
session_start();
...
// Fetch all CBAA board passers
$passers = $conn->query("SELECT * FROM anonymous_board_passers WHERE department='Business Administration and Accountancy' AND (is_deleted IS NULL OR is_deleted = 0) ORDER BY board_exam_date DESC");
...
<head>
    ...
    <title>College of Business Administration & Accountancy - Board Performance Analytics | LSPU</title>
    ...
    <style>
        :root {
            /* CBAA Golden/Amber Color Palette */
            --gold-1: #FCD34D;  /* Light gold */
            --gold-2: #FBBF24;  /* Pale gold */
            --gold-3: #F59E0B;  /* Medium gold */
            --gold-4: #D97706;  /* Dark gold */
            --gold-5: #FEF3C7;  /* Very light gold */
            ...
            --gradient-dark: linear-gradient(135deg, #B45309 0%, #D97706 100%);
            --gradient-light: linear-gradient(135deg, #FCD34D 0%, #FEF3C7 100%);
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .bg-pattern {
            ...
            opacity: 0.4;
            background-image: 
                radial-gradient(circle at 20% 80%, var(--gold-3) 0%, transparent 50%),
                radial-gradient(circle at 80% 20%, var(--gold-2) 0%, transparent 50%),
                radial-gradient(circle at 40% 40%, var(--gold-5) 0%, transparent 30%);
        }
...
<body>
        ...
        <div class="header-main">
            <div class="header-brand">
                ...
                <div class="header-title">
                    <h1>College of Business Administration & Accountancy</h1>
    ...
    <main class="main">
        ...
        <section class="kpi-section">
            <div class="section-header">
                ...
                <p>Overall board examination statistics for College of Business Administration & Accountancy (<?php echo $year_range; ?>)</p>
            </div>
        ...
        <section class="exam-comparison-section">
            <div class="section-header">
                ...
                <p>Comparative analysis of different CBAA licensure examinations</p>
            </div>
                ...
                <div class="chart-card">
                    <div class="chart-header">
                        <div class="chart-title-group">
                            ...
                            <p>Pass/Fail breakdown for all CBAA board exams (<?php echo $year_range; ?>)</p>
                        </div>
                    </div>
                ...
                <div class="chart-card full-width">
                    <div class="chart-header">
                        <div class="chart-title-group">
                            ...
                            <p>Historical passing rate trends across all CBAA board examinations</p>
                        </div>
                        <div class="chart-legend-custom">
                            <div class="legend-item"><span class="legend-dot" style="background: #D97706;"></span> Passed</div>
                            <div class="legend-item"><span class="legend-dot" style="background: #94a3b8;"></span> Failed</div>
                            <div class="legend-item"><span class="legend-dot" style="background: #F59E0B;"></span> Pass Rate %</div>
                        </div>
                    </div>
                ...
                <div class="chart-card">
                    <div class="chart-header">
                        <div class="chart-title-group">
                            ...
                            <p>Distribution of examinees across different CBAA boards</p>
                        </div>
                    </div>
                    <div class="chart-container">
    ...
    <footer class="footer">
        ...
        <p style="margin-top: 8px; opacity: 0.7; font-size: 0.8rem;">College of Business Administration & Accountancy Board Performance Analytics Dashboard</p>
    </footer>
    ...
    <script>
        ...
        async function fetchPredictions() {
            try {
                const response = await fetch('http://localhost:5002/api/predict', {
                    ...
                    body: JSON.stringify({ department: 'Business Administration and Accountancy', historical_rate: <?php echo $passing_rate; ?> })
                });
        ...
        function exportCSV(data, includeStats) {
            ...
            if (includeStats) {
                csv += 'COLLEGE OF BUSINESS ADMINISTRATION & ACCOUNTANCY - BOARD EXAMINATION STATISTICS\n';
            ...
            downloadFile(csv, 'cbaa_board_exam_data.csv', 'text/csv');
        }
        ...
        function exportJSON(data, includeStats) {
            ...
            downloadFile(JSON.stringify(exportData, null, 2), 'cbaa_board_exam_data.json', 'application/json');
        }
        ...
        function exportExcel(data, includeStats) {
            ...
            downloadFile(csv, 'cbaa_board_exam_data.xlsx', 'application/vnd.ms-excel');
        }
        ...
        function exportPDF(data, includeStats) {
            ...
            let html = `
                ...
                <html>
                <head>
                    <title>CBAA Board Exam Report</title>
                    <style>
                        body { font-family: Arial, sans-serif; padding: 20px; }
                        h1 { color: #D97706; border-bottom: 2px solid #D97706; padding-bottom: 10px; }
                        .stats { display: flex; gap: 20px; margin: 20px 0; }
                        .stat-box { background: #FEF3C7; padding: 15px 25px; border-radius: 8px; text-align: center; }
                        .stat-value { font-size: 24px; font-weight: bold; color: #D97706; }
                        .stat-label { font-size: 12px; color: #666; }
                        table { width: 100%; border-collapse: collapse; margin-top: 20px; }
                        th { background: #D97706; color: white; padding: 10px; text-align: left; }
                        td { padding: 8px 10px; border-bottom: 1px solid #ddd; }
                        tr:nth-child(even) { background: #f9f9f9; }
                        .passed { color: #D97706; font-weight: bold; }
                        .failed { color: #dc2626; }
                        .footer { margin-top: 30px; text-align: center; color: #666; font-size: 12px; }
                    </style>
                </head>
                <body>
                    <h1>💼 College of Business Administration & Accountancy - Board Examination Report</h1>
                    ...
                    <div class="footer">
                        <p>LSPU San Pablo City Campus - College of Business Administration & Accountancy</p>
                    </div>
                </body>
                </html>
            `;
        ...
        <div class="info-modal">
            ...
            <div class="info-modal-body">
                ...
                <div class="data-source-box">
                    ...
                    <p>All visualizations are generated from <strong>anonymous board examination records</strong> stored in the LSPU Board Performance System database. Data includes examination results from <?php echo $year_range; ?>, covering all licensure examinations under the College of Business Administration and Accountancy. Personal identifying information is not displayed to protect student privacy. Data is updated as new examination results become available.</p>
                </div>
            </div>
        </div>
    </div>
