"""
Training Report Generator for CTE Department
...
class CTETrainingReportGenerator:
    def __init__(self):
        self.db_config = {
            'host': 'localhost',
            'database': 'project_db',
    ...
    def fetch_training_data(self):
        """Fetch all CTE anonymous training data"""
    ...
    def generate_report(self):
        ...
        print("\n📄 Generating CTE Training Report...")
        ...
        filename = f"{self.output_dir}/CTE_Training_Report_{timestamp}.pdf"
        ...
        # Custom styles - CTE Blue theme
        title_style = ParagraphStyle(
            'CustomTitle',
            parent=styles['Heading1'],
            fontSize=22,
            textColor=colors.HexColor('#4663ac'),
            spaceAfter=12,
            alignment=TA_CENTER,
        ...
        elements.append(Paragraph("College of Teacher Education", subtitle_style))
        ...
        cover_table.setStyle(TableStyle([
            ...
            ('FONTSIZE', (0, 0), (-1, -1), 11),
            ('TEXTCOLOR', (0, 0), (0, -1), colors.HexColor('#4663ac')),
        ...
        intro_text = """
        This report documents the complete machine learning training process for the CTE (College of Teacher 
        Education) Board Exam Prediction System. The system uses historical anonymous board exam data to predict 
        future passing rates using advanced regression algorithms. This AI-powered prediction system aims to help 
        the institution make data-driven decisions regarding board exam preparation, specifically for the 
        Licensure Examination for Teachers (LET), and student support programs.
        """
        ...
        • Filtered only records from the CTE department<br/><br/>
        ...
        feature_descriptions = {
            ...
            'is_Licensure_Examination_for_Teachers_LET': 'Binary indicator for LET exam type',
        ...
        if len(feature_table_data) > 1:
            ...
            feature_table.setStyle(TableStyle([
                ('BACKGROUND', (0, 0), (-1, 0), colors.HexColor('#4663ac')),
                ...
                ('GRID', (0, 0), (-1, -1), 1, colors.HexColor('#c1d8f0')),
        ...
        if metadata and 'metrics' in metadata:
            ...
            mse_val = rmse_val ** 2 if rmse_val else 0
            ...
            best_metrics_data = [
                ...
                ['Dataset Used', f"CTE ({len(training_data)} records)", f"{training_data['exam_year'].min()}-{training_data['exam_year'].max()}"],
            ]
            ...
            best_table.setStyle(TableStyle([
                ...
                ('GRID', (0, 0), (-1, -1), 1, colors.HexColor('#4663ac')),
            ]))
        ...
        if metadata and 'metrics' in metadata:
            ...
            metrics_data = [['Model', 'R² Score', 'MAE (%)', 'RMSE (%)', 'Accuracy (%)']]
            ...
            metrics_table = Table(metrics_data, colWidths=[2.2*inch, 1.1*inch, 1*inch, 1*inch, 1.1*inch])
        ...
        the CTE Board Exam Prediction System. The system was trained on {len(training_data)} historical records 
        ...
        <i>Report generated by LSPU CTE AI Board Exam Prediction System</i><br/>
        <i>{report_date}</i>
        """
...
if __name__ == "__main__":
    generator = CTETrainingReportGenerator()
