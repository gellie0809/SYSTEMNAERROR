...
if (isset($_GET['export']) && $_GET['export'] === 'csv') {
    ...
    if ($result->num_rows > 0) {
        ...
        header('Content-Disposition: attachment; filename="ccje_criminology_passers_' . date('Y-m-d_H-i-s') . '.csv"');
        ...
        // Add CSV headers
        fputcsv($output, ['Full Name', 'Course', 'Year Graduated', 'CLE Date', 'Result', 'Take Attempt', 'Exam Type']);
        
        // Add data rows
        while ($row = $result->fetch_assoc()) {
            // Format the date properly (Y-m-d) to avoid Excel auto-formatting issues
        ...
        $error_message = "No CCJE board passers found to export.";
    }
}
...
<head>
    ...
    <title>Export Data - CCJE Dashboard</title>
    ...
    * {
    ...
    .export-card:hover {
        ...
        box-shadow: 0 25px 70px rgba(211, 47, 47, 0.2);
    ...
    #logoutModal .modal-icon::before {
        ...
        background: linear-gradient(135deg, #E63946, #D32F2F, #800020, #C62828) !important;
        border-radius: 50% !important;
        z-index: -1 !important;
    ...
    #logoutModal .modal-btn.logout-confirm:hover {
        background: linear-gradient(135deg, #5D0016 0%, #800020 50%, #C1121F 100%) !important;
    ...
    #logoutModal .modal-btn.logout-confirm:active {
        ...
        background: linear-gradient(135deg, #5D0016 0%, #C1121F 50%, #800020 100%) !important;
    }
    ...
    #logoutModal .modal-btn.logout-cancel:hover {
        background: linear-gradient(135deg, #FAD6A5 0%, #F5C89B 100%) !important;
        ...
        <div class="card">
            <div class="card-header">
                <div class="header-content">
                    ...
                    <div>
                        <h1 class="header-title">Export Board Passers Data – College of Criminal Justice Education</h1>
                    ...
                    <div class="info-card">
                        ...
                        <ul>
                            ...
                            <li><strong>Data Included:</strong> Name, Course, Graduation Year, Board Exam Date, Result,
                                Exam Type, Rating</li>
                            <li><strong>Filtering:</strong> Only College of Arts & Sciences records</li>
