  ...
  <style>
    * {
    ...
    .card h2 {
      ...
      margin-bottom: 24px;
      color: #ffffff;
      background: linear-gradient(135deg, #1e40af 0%, #06b6d4 100%); /* Navy to Cyan gradient */
      padding: 20px 32px;
      border-radius: 12px;
    ...
    .board-table tbody tr:hover {
      background: linear-gradient(90deg, #fef3c7 0%, #fef9e7 100%); /* Warm amber-yellow tint */
    ...
    .btn:hover, .action-btn:hover, button.small:hover {
      background: #06b6d4;
      color: #ffffff;
    ...
    .board-table th:nth-child(1), .board-table td:nth-child(1) { width: 22%; text-align: left; } /* Name */
    .board-table th:nth-child(2), .board-table td:nth-child(2) { width: 18%; text-align: left; } /* Course */
    .board-table th:nth-child(3), .board-table td:nth-child(3) { width: 10%; text-align: center; } /* Year */
    .board-table th:nth-child(4), .board-table td:nth-child(4) { width: 12%; text-align: center; } /* Date */
    .board-table th:nth-child(5), .board-table td:nth-child(5) { width: 10%; text-align: center; } /* Result */
    .board-table th:nth-child(6), .board-table td:nth-child(6) { width: 10%; text-align: center; } /* Exam Type */
    .board-table th:nth-child(7), .board-table td:nth-child(7) { width: 16%; text-align: left; } /* Board Exam Type */
    .board-table th:nth-child(8), .board-table td:nth-child(8) { width: 12%; text-align: center; } /* Actions */
    ...
    .status-failed {
      background: linear-gradient(135deg, #f87171 0%, #ef4444 100%); /* Coral Red */
      color: #ffffff;
      border-color: #f87171;
      box-shadow: 0 2px 8px rgba(248, 113, 113, 0.3);
    }
    .status-cond {
      background: linear-gradient(135deg, #fbbf24 0%, #f59e0b 100%); /* Amber Yellow */
      color: #1a1a1a;
      border-color: #fbbf24;
    ...
    .exam-repeater {
      background: linear-gradient(135deg, #94a3b8 0%, #64748b 100%); /* Slate */
      color: #ffffff;
      border-color: #94a3b8;
...
.edit-btn {
  background: #f97316 !important; /* Warm Orange */
  color: white !important;
}
.edit-btn:hover {
  background: #ea580c !important; /* Deeper Orange */
  box-shadow: 0 6px 20px rgba(249, 115, 22, 0.4) !important;
}

.delete-btn {
  background: #ef4444 !important; /* Coral Red */
  color: white !important;
}
.delete-btn:hover {
  background: #dc2626 !important; /* Deeper Red */
  box-shadow: 0 6px 20px rgba(239, 68, 68, 0.4) !important;
}

.save-btn {
  background: #10b981 !important; /* Emerald Green - matches Passed status */
  color: white !important;
}
.save-btn:hover {
...
.cancel-btn {
  background: #64748b !important; /* Slate Gray */
  color: white !important;
}
.cancel-btn:hover {
...
.cancel-btn:hover {
  background: #6b7280;
    ...
    @keyframes rowUpdateFlash {
      0% { background: linear-gradient(90deg, #f0fdf4 0%, #dcfce7 100%) !important; }
      10% { background: linear-gradient(90deg, #f0fdf4 0%, #dcfce7 100%) !important; }
      100% { background: inherit !important; }
    }
    ...
    @media (max-width: 1200px) {
      .main-content { padding: 24px; }
      .card { padding: 32px 24px; }
      .board-table th, .board-table td { padding: 12px 16px; font-size: 0.85rem; }
      .action-btn { min-width: 55px !important; height: 30px !important; font-size: 12px !important; }
      .action-btn span { font-size: 9px !important; }
    ...
    @media (max-width: 900px) {
      ...
      .board-table th, .board-table td { font-size: 0.8rem; padding: 10px 12px; }
      .action-btn { min-width: 50px !important; height: 28px !important; font-size: 11px !important; }
      .action-btn span { font-size: 8px !important; }
      .status-badge { font-size: 0.65rem; padding: 2px 5px; }
    }
    @media (max-width: 600px) {
      ...
      .card { padding: 16px 8px; border-radius: 12px; }
      .board-table th, .board-table td { font-size: 0.75rem; padding: 8px 6px; }
      .table-container { 
        border-radius: 12px;
        box-shadow: 0 4px 16px rgba(22, 41, 56, 0.1);
      }
      .action-btn { min-width: 45px !important; height: 26px !important; font-size: 10px !important; }
      .action-btn span { font-size: 7px !important; }
      .actions-btns { 
      ...
      .board-table, .board-table thead, .board-table tbody, .board-table th, .board-table td, .board-table tr {
        display: block;
      }
    ...
    .filter-header {
      ...
      justify-content: space-between;
      align-items: center;
      padding: 16px 24px; /* Tighter, cleaner spacing */
    ...
    #editStudentForm { padding-bottom: 0; }
    ...
    #editStudentForm > .modal-buttons {
      ...
      margin: 16px 0 0 0; /* simple space above footer */
    ...
    #editStudentModal .modal-content {
      ...
      position: relative;
      max-width: 760px;  /* larger board card */
      width: 96%;
    }
    ...
    #editStudentModal .modal-header h3 { color: #fff; font-weight: 800; }
    #editStudentModal .modal-header p { color: rgba(255,255,255,0.92); }
    #editStudentModal .modal-close { color: #fff; border-color: rgba(255,255,255,0.3); }
    #editStudentModal .modal-close:hover { background: rgba(255,255,255,0.25); }

    /* Section headers */
    #editStudentModal .tab-header {
      padding: 16px 24px 12px !important; /* ensure a bit of bottom padding even if inline style sets 0 */
      background: #ffffff;
    ...
    #editStudentModal .tab-header h4 { color: #0ea5b1; font-weight: 800; }
  #editStudentModal .tab-header p { color: #6b7280; margin-top: 4px; margin-bottom: 14px; }

    /* Section block with subtle tint */
    #editStudentModal .section-block { background: #f8fafc; border: 1px solid #e5e7eb; border-radius: 12px; padding: 16px; }

    /* Inputs – neutral borders; teal focus */
  /* Align label contents (icon + text) nicely in Edit modal */
  #editStudentModal .form-group label { display: flex; align-items: center; gap: 8px; }
  #editStudentModal .form-group label i { color: #06b6d4; line-height: 1; display: inline-flex; align-items: center; justify-content: center; }
    
    /* Center the Exam Type label and selected value */
    #editStudentModal label[for="editExamType"],
    #addStudentModal  label[for="addExamType"] { justify-content: center; text-align: center; }
    
    #editExamType, #addExamType {
      text-align: center;           /* center placeholder/value in most browsers */
      text-align-last: center;      /* ensure the selected option is centered (Chrome/Edge/Firefox) */
    }
    /* Make Edit modal Exam Type select visually centered and comfortably wide */
    #editExamType { display: block; max-width: 420px; width: 100%; margin: 0 auto; }
    #editExamType option, #addExamType option { text-align: center; }
    #editStudentModal .form-group input,
    #editStudentModal .form-group select {
      border: 1.5px solid #e5e7eb;
      height: 48px;          /* unify control heights */
      line-height: 24px;      /* consistent text line height */
      font-size: 1rem;        /* consistent font */
    ...
    /* Required asterisk */
    #editStudentModal .form-group label.required::after { content: ' *'; color: #0ea5b1; font-weight: 700; }
  ...
  #editStudentModal .tab-header { border-bottom: 1px solid #e5edf5; margin-bottom: 18px; }
...
<body>
    ...
    <div class="stats-grid">
      ...
      <div class="stat-card">
        ...
        <div class="stat-content">
          ...
          <p>Top Course</p>
          <span class="stat-change neutral">
            <i class="fas fa-star"></i> <?= htmlspecialchars(substr($course_name ?? '', 0, 15)) ?><?= strlen($course_name ?? '') > 15 ? '...' : '' ?>
          </span>
        </div>
      </div>
    </div>
          ...
          <div class="filter-grid">
            ...
            <div class="filter-group">
              ...
              <select id="yearFilter" class="filter-input" multiple size="4">
                ...
                ?>
                  <option value="<?= htmlspecialchars($year['year_graduated']) ?>"><?= htmlspecialchars($year['year_graduated']) ?></option>
                <?php endwhile; ?>
              </select>
            </div>
            ...
            <div class="filter-group">
              <label for="examTypeFilter">Take Attempts <small>(Hold Ctrl/Cmd for multiple)</small></label>
            ...
            <div class="filter-group">
              ...
              <select id="boardExamTypeFilter" class="filter-input" multiple size="4">
                <?php foreach ($board_exam_types as $exam_type): ?>
                  <option value="<?= (int)$exam_type['id'] ?>" data-name="<?= htmlspecialchars($exam_type['name']) ?>"><?= htmlspecialchars($exam_type['name']) ?></option>
                <?php endforeach; ?>
              </select>
            </div>
          </div>
          ...
          <tbody>
            <?php if ($total_records > 0): ?>
              ...
              <tr data-id="<?= htmlspecialchars($row['id'] ?? '') ?>">
                ...
                <td class="editable" data-label="Year Graduated"><?= htmlspecialchars($row['year_graduated'] ?? '') ?></td>
                <td class="editable" data-label="Board Exam Date" data-date="<?= htmlspecialchars($row['board_exam_date'] ?? '') ?>"><?= htmlspecialchars($row['board_exam_date'] ?? '') ?></td>
              ...
              <td class="actions-btns" data-label="Actions">
                <button class="action-btn edit-btn" onclick="openEdit(this)" data-tooltip="Edit Record" title="Edit Record">
                  <i class="fas fa-edit"></i>
                  <span style="font-size: 10px; margin-left: 2px;">Edit</span>
                </button>
                <button class="action-btn delete-btn" onclick="deleteRow(this)" data-tooltip="Delete Record" title="Delete Record">
            ...
            <tr class="no-records-row">
              <td colspan="8" style="text-align: center; padding: 60px 20px; color: #6b7280; font-size: 1.1rem;">
                <div style="display: flex; flex-direction: column; align-items: center; gap: 20px;">
                  <div style="width: 80px; height: 80px; background: linear-gradient(135deg, #e2e8f0 0%, #cbd5e1 100%); border-radius: 50%; display: flex; align-items: center; justify-content: center;">
      ...
      <form id="editStudentForm">
        ...
        <div id="editStudentFormBody" class="form-grid" style="padding: 0 24px;">
          <div class="form-group">
            ...
            <input type="text" id="editLastName" name="last_name" required title="Only letters, spaces, commas, periods, apostrophes, and hyphens allowed">
            <div class="input-feedback"></div>
          </div>

          <div class="form-group">
            <label for="editFirstName"><i class="fas fa-user"></i>First Name *</label>
            <input type="text" id="editFirstName" name="first_name" required title="Only letters, spaces, commas, periods, apostrophes, and hyphens allowed">
            <div class="input-feedback"></div>
          </div>

          <div class="form-group">
            <label for="editMiddleName"><i class="fas fa-user"></i>Middle Name</label>
            <input type="text" id="editMiddleName" name="middle_name" title="Only letters, spaces, commas, periods, apostrophes, and hyphens allowed">
            <div class="input-feedback"></div>
          </div>

          <div class="form-group">
            <label for="editSuffix"><i class="fas fa-award"></i>Suffix</label>
            <input type="text" id="editSuffix" name="suffix" title="Only letters, spaces, commas, periods, apostrophes, and hyphens allowed">
            <div class="input-feedback"></div>
          </div>
        ...
        <div class="form-grid" style="padding: 0 24px;">
          ...
          <div class="form-group" style="grid-column: 1 / -1;">
            ...
            <select id="editBoardExamType" name="board_exam_type" required>
              ...
              <?php foreach ($board_exam_types as $exam_type): ?>
                <option value="<?= (int)$exam_type['id'] ?>" data-name="<?= htmlspecialchars($exam_type['name']) ?>" data-type-id="<?= (int)$exam_type['id'] ?>"><?= htmlspecialchars($exam_type['name']) ?></option>
              <?php endforeach; ?>
            </select>
          </div>
          ...
          <div class="form-group">
            ...
            <select id="editExamDate" name="board_exam_date">
              ...
              <?php foreach ($board_exam_dates as $exam_date): ?>
                <option value="<?= htmlspecialchars($exam_date['date']) ?>" data-exam-type="<?= htmlspecialchars($exam_date['exam_type_name']) ?>" data-exam-type-id="<?= htmlspecialchars($exam_date['exam_type_id']) ?>">
                  <?= date('F j, Y', strtotime($exam_date['date'])) ?>
                  <?php if (!empty($exam_date['description'])): ?> - <?= htmlspecialchars($exam_date['description']) ?><?php endif; ?>
                </option>
              <?php endforeach; ?>
              <option value="other" data-exam-type="">Other Date (Not Listed)</option>
            </select>
            <div id="editExamDateHint" class="small-hint" style="display:none;color:#6b7280;font-size:12px;margin-top:6px;">Select Board Exam Type first</div>
          </div>
          ...
          <div class="form-group">
            ...
            <input type="number" step="0.01" min="0" max="100" id="editRating" name="rating" placeholder="e.g., 85.25">
          </div>
  </div>

        <div style="padding: 0 24px 16px; margin-top: 8px;">
          <div id="editSubjectsContainer" style="display:none; background:#f8fafc; border:1px solid #e5e7eb; border-radius:12px; padding:16px;">
            <div style="font-weight:700; color:#1f2937; margin-bottom:10px; display:flex; align-items:center; gap:8px;"><i class="fas fa-book"></i>Per-subject Grades</div>
            <div id="editSubjectsList" style="display:flex; flex-direction:column; gap:10px;"></div>
          </div>
          <div id="editNoSubjectsPlaceholder" style="display:none; color:#6b7280; font-size:0.95rem; padding:10px;">No subjects available for selected board exam type.</div>
        </div>
        ...
        <div id="personalTab" class="tab-content active">
          ...
          <div class="form-grid">
            ...
            <div class="form-group">
              ...
              <input type="text" id="addSuffix" name="suffix"
        ...
        <div id="examTab" class="tab-content">
          ...
          <div class="form-grid">
            ...
            <div class="form-group">
              ...
              <div id="addExamDateHint" class="small-hint" style="display:none;color:#6b7280;font-size:12px;margin-top:6px;">Select Board Exam Type first</div>
            </div>
  ...
  <div id="deleteModal" class="modal">
    <div class="modal-content">
      <div class="modal-header" style="background: linear-gradient(135deg, #ef4444 0%, #dc2626 100%); color: white; border-radius: 12px 12px 0 0; position: relative; overflow: hidden;">
        <div style="position: absolute; top: 0; left: 0; right: 0; bottom: 0; background: radial-gradient(circle at 30% 20%, rgba(255,255,255,0.1) 1px, transparent 1px), radial-gradient(circle at 70% 80%, rgba(255,255,255,0.08) 1px, transparent 1px); opacity: 0.6;"></div>
        <div style="position: relative; z-index: 1; padding: 24px;">
          <div class="modal-icon" style="background: rgba(255,255,255,0.2); width: 60px; height: 60px; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 15px; backdrop-filter: blur(10px); border: 2px solid rgba(255,255,255,0.3);">
            <i class="fas fa-exclamation-triangle" style="font-size: 24px; color: #fff;"></i>
          </div>
          <h3 style="margin: 0 0 8px 0; font-size: 1.5rem; font-weight: 700; text-align: center;">Confirm Deletion</h3>
          <p style="margin: 0; opacity: 0.9; text-align: center; font-size: 0.9rem;">This action cannot be undone!</p>
        </div>
      </div>
      <div class="modal-body" style="padding: 32px 24px; text-align: center; background: linear-gradient(135deg, #f8fafc 0%, #f1f5f9 100%);">
        <div style="background: white; padding: 20px; border-radius: 12px; border: 1px solid #e2e8f0; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1); margin-bottom: 24px;">
          ...
          <p style="color: #374151; font-size: 1.1rem; line-height: 1.6; margin: 0;">
            ...
            <small style="color: #6b7280; font-size: 0.9rem;">This action will permanently remove all data associated with this student.</small>
          </p>
        </div>
      </div>
      <div class="modal-buttons" style="padding: 0 24px 24px 24px; display: flex; gap: 12px; justify-content: center;">
        <button id="cancelDelete" class="btn-secondary" style="background: linear-gradient(135deg, #f1f5f9 0%, #e2e8f0 100%); color: #475569; border: 1px solid #cbd5e1; padding: 12px 24px; border-radius: 8px; font-weight: 600; transition: all 0.2s ease; display: flex; align-items: center; gap: 8px; min-width: 120px; justify-content: center;">
          <i class="fas fa-times"></i> Cancel
        </button>
        <button id="confirmDelete" class="btn-danger" style="background: linear-gradient(135deg, #ef4444 0%, #dc2626 100%); color: white; border: none; padding: 12px 24px; border-radius: 8px; font-weight: 600; transition: all 0.2s ease; display: flex; align-items: center; gap: 8px; min-width: 120px; justify-content: center; box-shadow: 0 4px 6px -1px rgba(239, 68, 68, 0.3);">
  ...
  async function openEdit(btn) {
      try {
        ...
        const resp = await fetch('get_board_passer.php?id=' + encodeURIComponent(id), { headers: { 'X-Requested-With': 'XMLHttpRequest' } });
        const rawText = await resp.text();
        let data;
        try { data = JSON.parse(rawText); } catch (_) { data = null; }
        if (!resp.ok) {
          const msg = data && data.message ? data.message : ('Server returned ' + resp.status + (rawText ? (' — ' + rawText.substring(0,120)) : ''));
          throw new Error(msg);
        }
        if (!data) {
        ...
        if (betSelect) {
          ...
          if (rec.board_exam_type) {
            ...
            for (let i = 0; i < betSelect.options.length; i++) {
              if (String(betSelect.options[i].value) === String(rec.board_exam_type)) { betSelect.selectedIndex = i; setOk = true; break; }
            }
            if (!setOk) {
              // Try match by data-name
              for (let i = 0; i < betSelect.options.length; i++) {
                if (betSelect.options[i].dataset && betSelect.options[i].dataset.name === String(rec.board_exam_type)) { betSelect.selectedIndex = i; setOk = true; break; }
              }
            }
          }
        ...
        try { filterExamDates('editBoardExamType','editExamDate'); } catch(e) {}
          ...
          const toggleCustom = () => {
            if (dateSelect.value === 'other') {
              ...
              if (customDateInput) {
                ...
                customDateInput.value = (rec.board_exam_date && dateSelect.value === 'other') ? rec.board_exam_date : '';
              }
        ...
        document.getElementById('originalCourse').value = (row.querySelector('td:nth-child(2)')?.textContent || '').trim();
        document.getElementById('originalYear').value = (row.querySelector('td:nth-child(3)')?.textContent || '').trim();
        document.getElementById('originalDate').value = (row.querySelector('td:nth-child(4)')?.getAttribute('data-date') || row.querySelector('td:nth-child(4)')?.textContent || '').trim();
        ...
        document.getElementById('originalBoardExamType').value = (row.querySelector('td:nth-child(7)')?.textContent || '').trim();
        ...
        ['editLastName','editFirstName','editMiddleName','editSuffix'].forEach(id => {
          const el = document.getElementById(id); if (el) el.addEventListener('input', setFullNameHidden);
        });
        ...
        (function(){
          ...
          try {
            ...
            if (!typeEl.value || typeEl.value === '') {
              dateEl.disabled = true; dateEl.selectedIndex = 0; dateEl.style.display = 'none'; if (hintEl) hintEl.style.display = '';
            } else {
              dateEl.disabled = false; dateEl.style.display = ''; if (hintEl) hintEl.style.display = 'none'; filterExamDates('editBoardExamType','editExamDate');
            }
          } catch(e) {}
        })();
        ...
        try {
          await (async () => { await loadSubjectsForPair('editBoardExamType','editExamDate','editSubjectsContainer','editSubjectsList','editNoSubjectsPlaceholder', id); })();
          // Prefill grades if any
          if (Array.isArray(subjectsExisting)) {
            subjectsExisting.forEach(su => {
              const gradeInput = document.querySelector("input[name='edit_subject_grade_" + su.subject_id + "']");
              const resultHidden = document.querySelector("input[name='edit_subject_result_" + su.subject_id + "']");
              if (gradeInput) gradeInput.value = su.grade != null ? String(su.grade) : '';
              if (resultHidden) resultHidden.value = (su.result === 1 || su.passed === 1 || su.result === 'Passed') ? 'Passed' : (su.result === 'Failed' ? 'Failed' : '');
            });
          }
        } catch (e) { /* silent */ }
    ...
    function addAddFormValidation() {
      ...
      const validateName = (input, fieldName) => {
        ...
        if (input.required && (!namePattern.test(input.value.trim()) || input.value.trim().length < 2)) {
          ...
          feedback.textContent = `Enter a valid ${fieldName} (letters, spaces, commas, periods, and hyphens only)`;
          feedback.className = 'input-feedback show error';
          input.setCustomValidity(`Enter a valid ${fieldName}`);
        } else if (!input.required && input.value.trim() && (!namePattern.test(input.value.trim()) || input.value.trim().length < 1)) {
          input.style.borderColor = '#ef4444';
          input.style.background = '#fef2f2';
          feedback.textContent = `Enter a valid ${fieldName} (letters, spaces, commas, periods, and hyphens only)`;
          feedback.className = 'input-feedback show error';
          ...
          boardExamDates.forEach(dateObj => {
            ...
            if (selectedTypeIds.includes(String(dateObj.exam_type_id))) {
              ...
              if (!addedDates.has(dateKey)) {
                ...
                option.textContent = dateObj.date + (dateObj.description ? ' — ' + dateObj.description : '');
  ...
  confirmBtn.addEventListener('mousedown', ()=>{ confirmBtn.style.transform='translateY(1px) scale(0.99)'; });
  confirmBtn.addEventListener('mouseup', ()=>{ confirmBtn.style.transform=''; });
  cancelBtn.addEventListener('mousedown', ()=>{ cancelBtn.style.transform='translateY(1px) scale(0.99)'; });
  cancelBtn.addEventListener('mouseup', ()=>{ cancelBtn.style.transform=''; });
  // Ripples
  ...
  let headers = ['Name', 'Course', 'Year Graduated', 'Board Exam Date', 'Result', 'Take Attempts', 'Board Exam Type'];
          ...
          const matches = filters.boardExamTypes.some(type => {
            ...
            return rowData.boardExamType.includes(typeStr.toLowerCase()) ||
                   (window.BOARD_EXAM_TYPE_MAP && window.BOARD_EXAM_TYPE_MAP[type] && 
                    rowData.boardExamType.includes(window.BOARD_EXAM_TYPE_MAP[type].toLowerCase()));
          });
          if (!matches) shouldShow = false;
        }
    ...
    function exportToCSV(data) {
      const headers = ['Name', 'Course', 'Year Graduated', 'Board Exam Date', 'Result', 'Take Attempts', 'Board Exam Type'];
      const csvContent = [
        headers.join(','),
        ...data.map(row => [
          `"${row.name}"`,
    ...
    ">
      ...
      ">
        ...
        <button onclick="closeExportModal()" class="export-modal-close" style="
          ...
          backdrop-filter: blur(10px);
          border: 1px solid rgba(255, 255, 255, 0.2);
        " onmouseover="this.style.background='rgba(255, 255, 255, 0.25)'; this.style.transform='scale(1.1) rotate(90deg)'" onmouseout="this.style.background='rgba(255, 255, 255, 0.15)'; this.style.transform='scale(1) rotate(0deg)'">
          <i class="fas fa-times"></i>
        </button>
    ...
    (function(){
      ...
      document.addEventListener('DOMContentLoaded', function(){
        ...
        if (addType && addDate) {
          ...
          addType.addEventListener('change', function(){ window.updateDateEnabled(addType, addDate); });
        }
        if (editType && editDate) {
          window.updateDateEnabled(editType, editDate);
          editType.addEventListener('change', function(){ window.updateDateEnabled(editType, editDate); });
        }
      });
    })();
  </script>
