...
// Load board exam types (Business Administration and Accountancy only, exclude deleted)
$board_exam_types = [];
$type_stmt = $conn->prepare("SELECT id, exam_type_name FROM board_exam_types WHERE department='Business Administration and Accountancy' AND (is_deleted IS NULL OR is_deleted = 0) ORDER BY exam_type_name");
...
$dates_sql = "SELECT d.exam_date, d.exam_description, d.exam_type_id
        ...
        WHERE d.department='Business Administration and Accountancy' AND YEAR(d.exam_date) BETWEEN 2019 AND 2024
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add_anonymous'])) {
    ...
    if (empty($errors)) {
        ...
        $stmt = $conn->prepare("INSERT INTO anonymous_board_passers (board_exam_type, board_exam_date, exam_type, result, department) VALUES (?, ?, ?, ?, 'Business Administration and Accountancy')");
        if ($stmt) {
...
<head>
    ...
    <title>Testing Anonymous Data - Business Administration and Accountancy</title>
...
<body>
    ...
    <div class="main">
        <div class="page-header">
            ...
            <a href="anonymous_dashboard_cbaa.php" class="view-dashboard-btn">
