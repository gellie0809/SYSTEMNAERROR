...
$betStmt = $conn->prepare("SELECT id, exam_type_name FROM board_exam_types WHERE department='Business Administration and Accountancy' ORDER BY exam_type_name ASC");
$betStmt->execute();
...
$bedStmt = $conn->prepare("SELECT id, exam_date, exam_description, exam_type_id FROM board_exam_dates WHERE department='Business Administration and Accountancy' ORDER BY exam_date DESC");
$bedStmt->execute();
...
<head>
    ...
    <title>View Statistics - CBAA</title>
...
<body>
            ...
            <div class="visual-panel">
                ...
                <div id="statsContainer" class="printable" style="position:relative;">
                    ...
                    <div id="printHeader" class="print-header" style="margin-bottom:12px; display:none;">
                        <h1 style="margin:0; font-size:20px;">CBAA Board Exam Statistics</h1>
                    ...
                    <!-- Overall CBAA Passing Rate Trend -->
    ...
    function renderOverallSubjectsBars(groups) {
        ...
        function fetchSubjectsTotalsForType(typeId) {
            return fetch(`stats_cbaa.php?action=subjects&boardExamTypeId=${encodeURIComponent(typeId)}`)
                .then(r => r.json())
